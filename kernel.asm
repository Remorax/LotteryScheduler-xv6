...
801002a1:	a1 80 09 11 80       	mov    0x80110980,%eax
801002a6:	3b 05 84 09 11 80    	cmp    0x80110984,%eax
...
801002b8:	68 80 09 11 80       	push   $0x80110980
801002bd:	e8 4e 3e 00 00       	call   80104110 <sleep>
  ...
  while(n > 0){
    while(input.r == input.w){
801002c2:	a1 80 09 11 80       	mov    0x80110980,%eax
801002c7:	83 c4 10             	add    $0x10,%esp
801002ca:	3b 05 84 09 11 80    	cmp    0x80110984,%eax
801002d0:	75 36                	jne    80100308 <consoleread+0x98>
      if(myproc()->killed){
801002d2:	e8 89 37 00 00       	call   80103a60 <myproc>
...
8010030b:	89 15 80 09 11 80    	mov    %edx,0x80110980
80100311:	89 c2                	mov    %eax,%edx
80100313:	83 e2 7f             	and    $0x7f,%edx
80100316:	0f be 92 00 09 11 80 	movsbl -0x7feef700(%edx),%edx
    if(c == C('D')){  // EOF
...
8010035e:	76 05                	jbe    80100365 <consoleread+0xf5>
        ...
        // caller gets a 0-byte result.
        input.r--;
80100360:	a3 80 09 11 80       	mov    %eax,0x80110980
...
801003a0:	e8 bb 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003a5:	c7 04 24 e3 79 10 80 	movl   $0x801079e3,(%esp)
...
8010082f:	75 54                	jne    80100885 <consoleintr+0x95>
    ...
    case C('H'): case '\x7f':  // Backspace
      if(input.e != input.w){
80100831:	a1 88 09 11 80       	mov    0x80110988,%eax
80100836:	3b 05 84 09 11 80    	cmp    0x80110984,%eax
8010083c:	74 d2                	je     80100810 <consoleintr+0x20>
        input.e--;
8010083e:	83 e8 01             	sub    $0x1,%eax
80100841:	a3 88 09 11 80       	mov    %eax,0x80110988
        consputc(BACKSPACE);
...
80100889:	a1 88 09 11 80       	mov    0x80110988,%eax
8010088e:	89 c2                	mov    %eax,%edx
80100890:	2b 15 80 09 11 80    	sub    0x80110980,%edx
...
801008a5:	83 ff 0d             	cmp    $0xd,%edi
        input.buf[input.e++ % INPUT_BUF] = c;
801008a8:	89 15 88 09 11 80    	mov    %edx,0x80110988
        consputc(BACKSPACE);
      }
      break;
    default:
...
801008b6:	88 88 00 09 11 80    	mov    %cl,-0x7feef700(%eax)
        consputc(c);
...
801008d5:	a1 80 09 11 80       	mov    0x80110980,%eax
801008da:	83 e8 80             	sub    $0xffffff80,%eax
801008dd:	39 05 88 09 11 80    	cmp    %eax,0x80110988
...
801008e9:	83 ec 0c             	sub    $0xc,%esp
      if(c != 0 && input.e-input.r < INPUT_BUF){
        ...
        if(c == '\n' || c == C('D') || input.e == input.r+INPUT_BUF){
          input.w = input.e;
801008ec:	a3 84 09 11 80       	mov    %eax,0x80110984
          wakeup(&input.r);
801008f1:	68 80 09 11 80       	push   $0x80110980
...
80100908:	a1 88 09 11 80       	mov    0x80110988,%eax
8010090d:	39 05 84 09 11 80    	cmp    %eax,0x80110984
80100913:	75 2b                	jne    80100940 <consoleintr+0x150>
80100915:	e9 f6 fe ff ff       	jmp    80100810 <consoleintr+0x20>
8010091a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
            input.buf[(input.e-1) % INPUT_BUF] != '\n'){
        input.e--;
80100920:	a3 88 09 11 80       	mov    %eax,0x80110988
        consputc(BACKSPACE);
...
8010092a:	e8 c1 fa ff ff       	call   801003f0 <consputc>
    ...
    case C('U'):  // Kill line.
      while(input.e != input.w &&
8010092f:	a1 88 09 11 80       	mov    0x80110988,%eax
80100934:	3b 05 84 09 11 80    	cmp    0x80110984,%eax
...
80100945:	83 e2 7f             	and    $0x7f,%edx
    ...
    case C('U'):  // Kill line.
      while(input.e != input.w &&
80100948:	80 ba 00 09 11 80 0a 	cmpb   $0xa,-0x7feef700(%edx)
...
80100977:	e9 74 3a 00 00       	jmp    801043f0 <procdump>
    ...
    default:
      if(c != 0 && input.e-input.r < INPUT_BUF){
        c = (c == '\r') ? '\n' : c;
        input.buf[input.e++ % INPUT_BUF] = c;
8010097c:	c6 80 00 09 11 80 0a 	movb   $0xa,-0x7feef700(%eax)
        consputc(c);
80100983:	b8 0a 00 00 00       	mov    $0xa,%eax
80100988:	e8 63 fa ff ff       	call   801003f0 <consputc>
8010098d:	a1 88 09 11 80       	mov    0x80110988,%eax
...
consoleinit(void)
{
  ...
  devsw[CONSOLE].write = consolewrite;
801009bb:	c7 05 4c 13 11 80 00 	movl   $0x80100600,0x8011134c
801009c2:	06 10 80 
  devsw[CONSOLE].read = consoleread;
801009c5:	c7 05 48 13 11 80 70 	movl   $0x80100270,0x80111348
801009cc:	02 10 80 
  cons.locking = 1;
...
801009fc:	e8 5f 30 00 00       	call   80103a60 <myproc>
...
80100d00:	e8 2b 3d 00 00       	call   80104a30 <safestrcpy>
...
80100d5b:	68 a0 09 11 80       	push   $0x801109a0
80100d60:	e8 5b 38 00 00       	call   801045c0 <initlock>
}
...
80100d74:	bb d4 09 11 80       	mov    $0x801109d4,%ebx
}
...
80100d79:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&ftable.lock);
80100d7c:	68 a0 09 11 80       	push   $0x801109a0
80100d81:	e8 3a 39 00 00       	call   801046c0 <acquire>
...
80100d93:	81 fb 34 13 11 80    	cmp    $0x80111334,%ebx
...
80100da5:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      release(&ftable.lock);
80100dac:	68 a0 09 11 80       	push   $0x801109a0
80100db1:	e8 2a 3a 00 00       	call   801047e0 <release>
      return f;
...
80100dc3:	68 a0 09 11 80       	push   $0x801109a0
80100dc8:	e8 13 3a 00 00       	call   801047e0 <release>
  return 0;
...
80100de7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ftable.lock);
80100dea:	68 a0 09 11 80       	push   $0x801109a0
80100def:	e8 cc 38 00 00       	call   801046c0 <acquire>
  if(f->ref < 1)
...
80100e04:	89 43 04             	mov    %eax,0x4(%ebx)
  release(&ftable.lock);
80100e07:	68 a0 09 11 80       	push   $0x801109a0
80100e0c:	e8 cf 39 00 00       	call   801047e0 <release>
  return f;
}
...
80100e39:	8b 7d 08             	mov    0x8(%ebp),%edi
  ...
  acquire(&ftable.lock);
80100e3c:	68 a0 09 11 80       	push   $0x801109a0
...
80100e5c:	74 1a                	je     80100e78 <fileclose+0x48>
    release(&ftable.lock);
80100e5e:	c7 45 08 a0 09 11 80 	movl   $0x801109a0,0x8(%ebp)
...
80100e6b:	5d                   	pop    %ebp
  ...
  if(--f->ref > 0){
    release(&ftable.lock);
80100e6c:	e9 6f 39 00 00       	jmp    801047e0 <release>
...
80100e8d:	8b 47 10             	mov    0x10(%edi),%eax
  ...
  f->type = FD_NONE;
  release(&ftable.lock);
80100e90:	68 a0 09 11 80       	push   $0x801109a0
    panic("fileclose");
  if(--f->ref > 0){
    release(&ftable.lock);
    return;
...
80100e95:	89 45 e0             	mov    %eax,-0x20(%ebp)
  ...
  f->type = FD_NONE;
  release(&ftable.lock);
80100e98:	e8 43 39 00 00       	call   801047e0 <release>
...
80100ec1:	e8 4a 26 00 00       	call   80103510 <pipeclose>
...
80100fbc:	5d                   	pop    %ebp
  ...
  if(f->type == FD_PIPE)
    return piperead(f->pipe, addr, n);
80100fbd:	e9 ee 26 00 00       	jmp    801036b0 <piperead>
...
801010db:	5d                   	pop    %ebp
  ...
  if(f->type == FD_PIPE)
    return pipewrite(f->pipe, addr, n);
801010dc:	e9 cf 24 00 00       	jmp    801035b0 <pipewrite>
      end_op();
...
80101109:	8b 0d a0 13 11 80    	mov    0x801113a0,%ecx
// Blocks.
...
8010112c:	03 05 b8 13 11 80    	add    0x801113b8,%eax
80101132:	50                   	push   %eax
80101133:	ff 75 d8             	pushl  -0x28(%ebp)
80101136:	e8 95 ef ff ff       	call   801000d0 <bread>
8010113b:	89 45 e4             	mov    %eax,-0x1c(%ebp)
8010113e:	a1 a0 13 11 80       	mov    0x801113a0,%eax
...
80101197:	39 05 a0 13 11 80    	cmp    %eax,0x801113a0
...
801011e5:	e8 46 36 00 00       	call   80104830 <memset>
  log_write(bp);
...
8010121a:	bb f4 13 11 80       	mov    $0x801113f4,%ebx
// Find the inode with number inum on device dev
// and return the in-memory copy. Does not lock
// the inode and does not read it from disk.
static struct inode*
...
80101222:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  ...
  acquire(&icache.lock);
80101225:	68 c0 13 11 80       	push   $0x801113c0
8010122a:	e8 91 34 00 00       	call   801046c0 <acquire>
...
8010124a:	81 fb 14 30 11 80    	cmp    $0x80113014,%ebx
...
80101268:	89 de                	mov    %ebx,%esi
  ...
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
    if(ip->ref > 0 && ip->dev == dev && ip->inum == inum){
      ip->ref++;
      release(&icache.lock);
8010126a:	68 c0 13 11 80       	push   $0x801113c0
...
8010126f:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
80101272:	e8 69 35 00 00       	call   801047e0 <release>
      return ip;
...
80101293:	81 fb 14 30 11 80    	cmp    $0x80113014,%ebx
...
801012b3:	c7 46 4c 00 00 00 00 	movl   $0x0,0x4c(%esi)
  release(&icache.lock);
801012ba:	68 c0 13 11 80       	push   $0x801113c0
801012bf:	e8 1c 35 00 00       	call   801047e0 <release>
...
801013d1:	e8 0a 35 00 00       	call   801048e0 <memmove>
  brelse(bp);
...
801013fc:	68 a0 13 11 80       	push   $0x801113a0
...
8010140e:	03 15 b8 13 11 80    	add    0x801113b8,%edx
...
80101474:	bb 00 14 11 80       	mov    $0x80111400,%ebx
80101479:	83 ec 0c             	sub    $0xc,%esp
  int i = 0;
  
  initlock(&icache.lock, "icache");
8010147c:	68 0b 74 10 80       	push   $0x8010740b
80101481:	68 c0 13 11 80       	push   $0x801113c0
80101486:	e8 35 31 00 00       	call   801045c0 <initlock>
...
8010149f:	e8 0c 30 00 00       	call   801044b0 <initsleeplock>
iinit(int dev)
{
  int i = 0;
...
801014a7:	81 fb 20 30 11 80    	cmp    $0x80113020,%ebx
...
801014b2:	68 a0 13 11 80       	push   $0x801113a0
801014b7:	ff 75 08             	pushl  0x8(%ebp)
801014ba:	e8 f1 fe ff ff       	call   801013b0 <readsb>
  cprintf("sb: size %d nblocks %d ninodes %d nlog %d logstart %d\
801014bf:	ff 35 b8 13 11 80    	pushl  0x801113b8
801014c5:	ff 35 b4 13 11 80    	pushl  0x801113b4
801014cb:	ff 35 b0 13 11 80    	pushl  0x801113b0
801014d1:	ff 35 ac 13 11 80    	pushl  0x801113ac
801014d7:	ff 35 a8 13 11 80    	pushl  0x801113a8
801014dd:	ff 35 a4 13 11 80    	pushl  0x801113a4
801014e3:	ff 35 a0 13 11 80    	pushl  0x801113a0
...
80101509:	83 3d a8 13 11 80 01 	cmpl   $0x1,0x801113a8
// Allocate an inode on device dev.
// Mark it as allocated by  giving it type type.
// Returns an unlocked but allocated and referenced inode.
struct inode*
...
8010153f:	39 1d a8 13 11 80    	cmp    %ebx,0x801113a8
80101545:	76 69                	jbe    801015b0 <ialloc+0xb0>
    bp = bread(dev, IBLOCK(inum, sb));
80101547:	89 d8                	mov    %ebx,%eax
80101549:	83 ec 08             	sub    $0x8,%esp
8010154c:	c1 e8 03             	shr    $0x3,%eax
8010154f:	03 05 b4 13 11 80    	add    0x801113b4,%eax
...
8010157e:	e8 ad 32 00 00       	call   80104830 <memset>
      dip->type = type;
...
801015d4:	03 05 b4 13 11 80    	add    0x801113b4,%eax
...
80101621:	e8 ba 32 00 00       	call   801048e0 <memmove>
  log_write(bp);
...
80101647:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&icache.lock);
8010164a:	68 c0 13 11 80       	push   $0x801113c0
8010164f:	e8 6c 30 00 00       	call   801046c0 <acquire>
  ip->ref++;
80101654:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101658:	c7 04 24 c0 13 11 80 	movl   $0x801113c0,(%esp)
8010165f:	e8 7c 31 00 00       	call   801047e0 <release>
  return ip;
}
...
80101692:	e8 59 2e 00 00       	call   801044f0 <acquiresleep>
...
801016b9:	03 05 b4 13 11 80    	add    0x801113b4,%eax
...
80101708:	e8 d3 31 00 00       	call   801048e0 <memmove>
    brelse(bp);
...
80101763:	e8 28 2e 00 00       	call   80104590 <holdingsleep>
...
iunlock(struct inode *ip)
{
  ...
  releasesleep(&ip->lock);
8010177f:	e9 cc 2d 00 00       	jmp    80104550 <releasesleep>
// Unlock the given inode.
void
iunlock(struct inode *ip)
{
...
801017b0:	e8 3b 2d 00 00       	call   801044f0 <acquiresleep>
...
801017ca:	e8 81 2d 00 00       	call   80104550 <releasesleep>

  acquire(&icache.lock);
801017cf:	c7 04 24 c0 13 11 80 	movl   $0x801113c0,(%esp)
801017d6:	e8 e5 2e 00 00       	call   801046c0 <acquire>
  ip->ref--;
801017db:	83 6e 08 01          	subl   $0x1,0x8(%esi)
  release(&icache.lock);
801017df:	83 c4 10             	add    $0x10,%esp
801017e2:	c7 45 08 c0 13 11 80 	movl   $0x801113c0,0x8(%ebp)
}
...
801017ef:	5d                   	pop    %ebp
  ...
  ip->ref--;
  release(&icache.lock);
801017f0:	e9 eb 2f 00 00       	jmp    801047e0 <release>
...
801017fb:	68 c0 13 11 80       	push   $0x801113c0
80101800:	e8 bb 2e 00 00       	call   801046c0 <acquire>
    int r = ip->ref;
80101805:	8b 5e 08             	mov    0x8(%esi),%ebx
    release(&icache.lock);
80101808:	c7 04 24 c0 13 11 80 	movl   $0x801113c0,(%esp)
8010180f:	e8 cc 2f 00 00       	call   801047e0 <release>
    if(r == 1){
...
801019f8:	e8 e3 2e 00 00       	call   801048e0 <memmove>
    brelse(bp);
...
80101a2a:	8b 04 c5 40 13 11 80 	mov    -0x7feeecc0(,%eax,8),%eax
...
80101af4:	e8 e7 2d 00 00       	call   801048e0 <memmove>
    log_write(bp);
...
80101b3a:	8b 04 c5 44 13 11 80 	mov    -0x7feeecbc(,%eax,8),%eax
...
80101b8e:	e8 cd 2d 00 00       	call   80104960 <strncmp>
}
80101b93:	c9                   	leave  
80101b94:	c3                   	ret    
...
80101bf5:	e8 66 2d 00 00       	call   80104960 <strncmp>
  for(off = 0; off < dp->size; off += sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("dirlookup read");
    if(de.inum == 0)
...
80101c63:	0f 84 53 01 00 00    	je     80101dbc <namex+0x16c>
    ...
    ip = idup(myproc()->cwd);
80101c69:	e8 f2 1d 00 00       	call   80103a60 <myproc>
// Increment reference count for ip.
// Returns ip to enable ip = idup(ip1) idiom.
struct inode*
idup(struct inode *ip)
...
{
  acquire(&icache.lock);
80101c74:	68 c0 13 11 80       	push   $0x801113c0
80101c79:	e8 42 2a 00 00       	call   801046c0 <acquire>
  ip->ref++;
80101c7e:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101c82:	c7 04 24 c0 13 11 80 	movl   $0x801113c0,(%esp)
80101c89:	e8 52 2b 00 00       	call   801047e0 <release>
...
80101ce5:	e8 f6 2b 00 00       	call   801048e0 <memmove>
    path++;
  if(*path == 0)
    return 0;
  s = path;
...
80101d74:	e8 67 2b 00 00       	call   801048e0 <memmove>
    name[len] = 0;
...
80101e5d:	e8 6e 2b 00 00       	call   801049d0 <strncpy>
  de.inum = inum;
...
80101ea8:	68 9e 7a 10 80       	push   $0x80107a9e
...
80101fe0:	e8 db 25 00 00       	call   801045c0 <initlock>
  ioapicenable(IRQ_IDE, ncpu - 1);
80101fe5:	58                   	pop    %eax
80101fe6:	a1 e0 36 11 80       	mov    0x801136e0,%eax
80101feb:	5a                   	pop    %edx
...
8010205e:	e8 5d 26 00 00       	call   801046c0 <acquire>
...
8010208e:	e8 6d 22 00 00       	call   80104300 <wakeup>
...
801020ac:	e8 2f 27 00 00       	call   801047e0 <release>
  // Start disk on next buf in queue.
  if(idequeue != 0)
    idestart(idequeue);
...
801020fe:	e8 8d 24 00 00       	call   80104590 <holdingsleep>
...
80102138:	e8 83 25 00 00       	call   801046c0 <acquire>
...
80102189:	e8 82 1f 00 00       	call   80104110 <sleep>
  // Start disk if necessary.
  if(idequeue == b)
    idestart(b);
...
801021a5:	c9                   	leave  
  ...
  release(&idelock);
801021a6:	e9 35 26 00 00       	jmp    801047e0 <release>
...
801021f1:	c7 05 14 30 11 80 00 	movl   $0xfec00000,0x80113014
801021f8:	00 c0 fe 
  ioapic->data = data;
}
...
80102206:	00 00 00 
  return ioapic->data;
80102209:	8b 15 14 30 11 80    	mov    0x80113014,%edx
...
80102212:	c7 02 00 00 00 00    	movl   $0x0,(%edx)
  return ioapic->data;
80102218:	8b 0d 14 30 11 80    	mov    0x80113014,%ecx
  int i, id, maxintr;
  ...
  if(id != ioapicid)
8010221e:	0f b6 15 40 31 11 80 	movzbl 0x80113140,%edx
ioapicinit(void)
{
  int i, id, maxintr;
...
80102244:	8b 0d 14 30 11 80    	mov    0x80113014,%ecx
...
80102260:	89 11                	mov    %edx,(%ecx)
  ioapic->data = data;
80102262:	8b 0d 14 30 11 80    	mov    0x80113014,%ecx
    cprintf("ioapicinit: id isn't equal to ioapicid; not a MP\n");
...
8010227e:	89 19                	mov    %ebx,(%ecx)
  ioapic->data = data;
80102280:	8b 0d 14 30 11 80    	mov    0x80113014,%ecx
...
{
  ioapic->reg = reg;
801022a1:	8b 0d 14 30 11 80    	mov    0x80113014,%ecx
  }
}
...
801022b3:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
801022b5:	8b 0d 14 30 11 80    	mov    0x80113014,%ecx
}
...
801022c4:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
801022c6:	a1 14 30 11 80       	mov    0x80113014,%eax
{
  // Mark interrupt edge-triggered, active high,
  // enabled, and routed to the given cpunum,
  // which happens to be that cpu's APIC ID.
...
801022f2:	81 fb a8 60 11 80    	cmp    $0x801160a8,%ebx
...
80102312:	e8 19 25 00 00       	call   80104830 <memset>

  if(kmem.use_lock)
80102317:	8b 15 54 30 11 80    	mov    0x80113054,%edx
...
80102324:	a1 58 30 11 80       	mov    0x80113058,%eax
80102329:	89 03                	mov    %eax,(%ebx)
  kmem.freelist = r;
  if(kmem.use_lock)
8010232b:	a1 54 30 11 80       	mov    0x80113054,%eax
  ...
  r->next = kmem.freelist;
  kmem.freelist = r;
80102330:	89 1d 58 30 11 80    	mov    %ebx,0x80113058
  if(kmem.use_lock)
...
8010233f:	90                   	nop
  ...
  if(kmem.use_lock)
    release(&kmem.lock);
80102340:	c7 45 08 20 30 11 80 	movl   $0x80113020,0x8(%ebp)
}
...
8010234a:	c9                   	leave  
  ...
  if(kmem.use_lock)
    release(&kmem.lock);
8010234b:	e9 90 24 00 00       	jmp    801047e0 <release>
...
80102353:	68 20 30 11 80       	push   $0x80113020
80102358:	e8 63 23 00 00       	call   801046c0 <acquire>
...
801023d0:	68 20 30 11 80       	push   $0x80113020
801023d5:	e8 e6 21 00 00       	call   801045c0 <initlock>
...
kinit1(void *vstart, void *vend)
{
  initlock(&kmem.lock, "kmem");
  kmem.use_lock = 0;
801023e0:	c7 05 54 30 11 80 00 	movl   $0x0,0x80113054
801023e7:	00 00 00 
...
kinit2(void *vstart, void *vend)
{
  freerange(vstart, vend);
  kmem.use_lock = 1;
80102474:	c7 05 54 30 11 80 01 	movl   $0x1,0x80113054
8010247b:	00 00 00 
}
...
80102494:	83 ec 04             	sub    $0x4,%esp
  ...
  if(kmem.use_lock)
80102497:	a1 54 30 11 80       	mov    0x80113054,%eax
8010249c:	85 c0                	test   %eax,%eax
8010249e:	75 30                	jne    801024d0 <kalloc+0x40>
    acquire(&kmem.lock);
  r = kmem.freelist;
801024a0:	8b 1d 58 30 11 80    	mov    0x80113058,%ebx
  if(r)
801024a6:	85 db                	test   %ebx,%ebx
801024a8:	74 1c                	je     801024c6 <kalloc+0x36>
    kmem.freelist = r->next;
801024aa:	8b 13                	mov    (%ebx),%edx
801024ac:	89 15 58 30 11 80    	mov    %edx,0x80113058
  if(kmem.use_lock)
801024b2:	85 c0                	test   %eax,%eax
801024b4:	74 10                	je     801024c6 <kalloc+0x36>
    release(&kmem.lock);
801024b6:	83 ec 0c             	sub    $0xc,%esp
801024b9:	68 20 30 11 80       	push   $0x80113020
801024be:	e8 1d 23 00 00       	call   801047e0 <release>
...
801024d3:	68 20 30 11 80       	push   $0x80113020
801024d8:	e8 e3 21 00 00       	call   801046c0 <acquire>
  r = kmem.freelist;
801024dd:	8b 1d 58 30 11 80    	mov    0x80113058,%ebx
  if(r)
801024e3:	83 c4 10             	add    $0x10,%esp
801024e6:	a1 54 30 11 80       	mov    0x80113054,%eax
...
{
  if(!lapic)
801025f0:	a1 5c 30 11 80       	mov    0x8011305c,%eax
...
{
  if (!lapic)
801026f0:	a1 5c 30 11 80       	mov    0x8011305c,%eax
  lapicw(TPR, 0);
}
...
{
  if(lapic)
80102710:	a1 5c 30 11 80       	mov    0x8011305c,%eax
}
...
{
  lapic[index] = value;
8010277e:	a1 5c 30 11 80       	mov    0x8011305c,%eax
...
801028e4:	e8 97 1f 00 00       	call   80104880 <memcmp>
...
801029b0:	8b 0d a8 30 11 80    	mov    0x801130a8,%ecx
...
80102a14:	e8 c7 1e 00 00       	call   801048e0 <memmove>
...
80102a34:	39 1d a8 30 11 80    	cmp    %ebx,0x801130a8
...
80102a57:	ff 35 94 30 11 80    	pushl  0x80113094
80102a5d:	ff 35 a4 30 11 80    	pushl  0x801130a4
80102a63:	e8 68 d6 ff ff       	call   801000d0 <bread>
  struct logheader *hb = (struct logheader *) (buf->data);
  int i;
  hb->n = log.lh.n;
80102a68:	8b 0d a8 30 11 80    	mov    0x801130a8,%ecx
...
80102a88:	8b 8a ac 30 11 80    	mov    -0x7feecf54(%edx),%ecx
...
80102abf:	68 60 30 11 80       	push   $0x80113060
80102ac4:	e8 f7 1a 00 00       	call   801045c0 <initlock>
  readsb(dev, &sb);
80102ac9:	58                   	pop    %eax
...
80102adb:	59                   	pop    %ecx
  ...
  log.size = sb.nlog;
  log.dev = dev;
80102adc:	89 1d a4 30 11 80    	mov    %ebx,0x801130a4
  ...
  log.start = sb.logstart;
  log.size = sb.nlog;
80102ae2:	89 15 98 30 11 80    	mov    %edx,0x80113098
    panic("initlog: too big logheader");
  ...
  readsb(dev, &sb);
  log.start = sb.logstart;
80102ae8:	a3 94 30 11 80       	mov    %eax,0x80113094
...
read_head(void)
{
  ...
  int i;
  log.lh.n = lh->n;
80102afd:	89 0d a8 30 11 80    	mov    %ecx,0x801130a8
  for (i = 0; i < log.lh.n; i++) {
...
80102b17:	89 8a a8 30 11 80    	mov    %ecx,-0x7feecf58(%edx)
{
  struct buf *buf = bread(log.dev, log.start);
  struct logheader *lh = (struct logheader *) (buf->data);
  int i;
...
80102b2a:	e8 81 fe ff ff       	call   801029b0 <install_trans>
  log.lh.n = 0;
80102b2f:	c7 05 a8 30 11 80 00 	movl   $0x0,0x801130a8
80102b36:	00 00 00 
...
80102b53:	83 ec 14             	sub    $0x14,%esp
  acquire(&log.lock);
80102b56:	68 60 30 11 80       	push   $0x80113060
80102b5b:	e8 60 1b 00 00       	call   801046c0 <acquire>
...
80102b6b:	68 60 30 11 80       	push   $0x80113060
80102b70:	68 60 30 11 80       	push   $0x80113060
80102b75:	e8 96 15 00 00       	call   80104110 <sleep>
...
begin_op(void)
{
  ...
  while(1){
    if(log.committing){
80102b7d:	a1 a0 30 11 80       	mov    0x801130a0,%eax
80102b82:	85 c0                	test   %eax,%eax
80102b84:	75 e2                	jne    80102b68 <begin_op+0x18>
      sleep(&log, &log.lock);
    } else if(log.lh.n + (log.outstanding+1)*MAXOPBLOCKS > LOGSIZE){
80102b86:	a1 9c 30 11 80       	mov    0x8011309c,%eax
80102b8b:	8b 15 a8 30 11 80    	mov    0x801130a8,%edx
...
80102b9f:	83 ec 0c             	sub    $0xc,%esp
      ...
      log.outstanding += 1;
80102ba2:	a3 9c 30 11 80       	mov    %eax,0x8011309c
      release(&log.lock);
80102ba7:	68 60 30 11 80       	push   $0x80113060
80102bac:	e8 2f 1c 00 00       	call   801047e0 <release>
      break;
    }
  }
}
...
80102bc6:	83 ec 18             	sub    $0x18,%esp
  ...
  acquire(&log.lock);
80102bc9:	68 60 30 11 80       	push   $0x80113060
80102bce:	e8 ed 1a 00 00       	call   801046c0 <acquire>
  log.outstanding -= 1;
80102bd3:	a1 9c 30 11 80       	mov    0x8011309c,%eax
  if(log.committing)
80102bd8:	8b 1d a0 30 11 80    	mov    0x801130a0,%ebx
...
end_op(void)
{
  ...
  acquire(&log.lock);
  log.outstanding -= 1;
80102be6:	a3 9c 30 11 80       	mov    %eax,0x8011309c
  if(log.committing)
...
80102bf9:	83 ec 0c             	sub    $0xc,%esp
  ...
  if(log.outstanding == 0){
    do_commit = 1;
    log.committing = 1;
80102bfc:	c7 05 a0 30 11 80 01 	movl   $0x1,0x801130a0
80102c03:	00 00 00 
}
...
80102c06:	31 db                	xor    %ebx,%ebx
  ...
  release(&log.lock);
80102c08:	68 60 30 11 80       	push   $0x80113060
80102c0d:	e8 ce 1b 00 00       	call   801047e0 <release>
}
...
{
  if (log.lh.n > 0) {
80102c12:	8b 0d a8 30 11 80    	mov    0x801130a8,%ecx
...
80102c28:	a1 94 30 11 80       	mov    0x80113094,%eax
80102c2d:	83 ec 08             	sub    $0x8,%esp
80102c30:	01 d8                	add    %ebx,%eax
80102c32:	83 c0 01             	add    $0x1,%eax
80102c35:	50                   	push   %eax
80102c36:	ff 35 a4 30 11 80    	pushl  0x801130a4
80102c3c:	e8 8f d4 ff ff       	call   801000d0 <bread>
80102c41:	89 c6                	mov    %eax,%esi
    struct buf *from = bread(log.dev, log.lh.block[tail]); // cache block
80102c43:	58                   	pop    %eax
80102c44:	5a                   	pop    %edx
80102c45:	ff 34 9d ac 30 11 80 	pushl  -0x7feecf54(,%ebx,4)
80102c4c:	ff 35 a4 30 11 80    	pushl  0x801130a4
static void
write_log(void)
{
  int tail;
...
80102c6c:	e8 6f 1c 00 00       	call   801048e0 <memmove>
...
80102c8c:	3b 1d a8 30 11 80    	cmp    0x801130a8,%ebx
...
80102c99:	e8 12 fd ff ff       	call   801029b0 <install_trans>
    log.lh.n = 0;
80102c9e:	c7 05 a8 30 11 80 00 	movl   $0x0,0x801130a8
80102ca5:	00 00 00 
...
80102cb0:	68 60 30 11 80       	push   $0x80113060
80102cb5:	e8 06 1a 00 00       	call   801046c0 <acquire>
    log.committing = 0;
    wakeup(&log);
80102cba:	c7 04 24 60 30 11 80 	movl   $0x80113060,(%esp)
  if(do_commit){
    // call commit w/o holding locks, since not allowed
    // to sleep with locks.
    commit();
    acquire(&log.lock);
    log.committing = 0;
80102cc1:	c7 05 a0 30 11 80 00 	movl   $0x0,0x801130a0
80102cc8:	00 00 00 
    wakeup(&log);
80102ccb:	e8 30 16 00 00       	call   80104300 <wakeup>
    release(&log.lock);
80102cd0:	c7 04 24 60 30 11 80 	movl   $0x80113060,(%esp)
80102cd7:	e8 04 1b 00 00       	call   801047e0 <release>
...
80102cf3:	68 60 30 11 80       	push   $0x80113060
80102cf8:	e8 03 16 00 00       	call   80104300 <wakeup>
  }
  release(&log.lock);
80102cfd:	c7 04 24 60 30 11 80 	movl   $0x80113060,(%esp)
80102d04:	e8 d7 1a 00 00       	call   801047e0 <release>
...
80102d37:	8b 15 a8 30 11 80    	mov    0x801130a8,%edx
//   modify bp->data[]
//   log_write(bp)
//   brelse(bp)
void
...
80102d69:	68 60 30 11 80       	push   $0x80113060
80102d6e:	e8 4d 19 00 00       	call   801046c0 <acquire>
  for (i = 0; i < log.lh.n; i++) {
80102d73:	8b 15 a8 30 11 80    	mov    0x801130a8,%edx
...
80102d84:	31 c0                	xor    %eax,%eax
    if (log.lh.block[i] == b->blockno)   // log absorbtion
80102d86:	3b 0d ac 30 11 80    	cmp    0x801130ac,%ecx
80102d8c:	75 0b                	jne    80102d99 <log_write+0x69>
80102d8e:	eb 38                	jmp    80102dc8 <log_write+0x98>
80102d90:	39 0c 85 ac 30 11 80 	cmp    %ecx,-0x7feecf54(,%eax,4)
...
80102da0:	89 0c 95 ac 30 11 80 	mov    %ecx,-0x7feecf54(,%edx,4)
  if (i == log.lh.n)
    log.lh.n++;
80102da7:	83 c2 01             	add    $0x1,%edx
80102daa:	89 15 a8 30 11 80    	mov    %edx,0x801130a8
  b->flags |= B_DIRTY; // prevent eviction
80102db0:	83 0b 04             	orl    $0x4,(%ebx)
  release(&log.lock);
80102db3:	c7 45 08 60 30 11 80 	movl   $0x80113060,0x8(%ebp)
}
...
80102dbd:	c9                   	leave  
  ...
  b->flags |= B_DIRTY; // prevent eviction
  release(&log.lock);
80102dbe:	e9 1d 1a 00 00       	jmp    801047e0 <release>
80102dc3:	90                   	nop
80102dc4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  log.lh.block[i] = b->blockno;
80102dc8:	89 0c 85 ac 30 11 80 	mov    %ecx,-0x7feecf54(,%eax,4)
80102dcf:	eb df                	jmp    80102db0 <log_write+0x80>
80102dd1:	8b 43 08             	mov    0x8(%ebx),%eax
80102dd4:	a3 ac 30 11 80       	mov    %eax,0x801130ac
  if (i == log.lh.n)
...
80102e07:	e8 34 0c 00 00       	call   80103a40 <cpuid>
80102e0c:	89 c3                	mov    %eax,%ebx
80102e0e:	e8 2d 0c 00 00       	call   80103a40 <cpuid>
...
80102e27:	e8 94 0b 00 00       	call   801039c0 <mycpu>
...
80102e3a:	e8 31 0f 00 00       	call   80103d70 <scheduler>
80102e3f:	90                   	nop
...
80102e6f:	bb 60 31 11 80       	mov    $0x80113160,%ebx
// Allocate a real stack and switch to it, first
// doing some setup required for memory allocator to work.
int
main(void)
...
80102e7c:	68 a8 60 11 80       	push   $0x801160a8
...
80102e95:	e8 96 3c 00 00       	call   80106b30 <seginit>
  picinit();       // disable pic
80102e9a:	e8 51 05 00 00       	call   801033f0 <picinit>
...
80102ea9:	e8 52 2f 00 00       	call   80105e00 <uartinit>
  pinit();         // process table
80102eae:	e8 ed 0a 00 00       	call   801039a0 <pinit>
  tvinit();        // trap vectors
...
80102ed9:	e8 02 1a 00 00       	call   801048e0 <memmove>

  for(c = cpus; c < cpus+ncpu; c++){
80102ede:	69 05 e0 36 11 80 b0 	imul   $0xb0,0x801136e0,%eax
80102ee5:	00 00 00 
80102ee8:	83 c4 10             	add    $0x10,%esp
80102eeb:	05 60 31 11 80       	add    $0x80113160,%eax
80102ef0:	39 d8                	cmp    %ebx,%eax
80102ef2:	76 6f                	jbe    80102f63 <main+0x103>
80102ef4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(c == mycpu())  // We've started already.
80102ef8:	e8 c3 0a 00 00       	call   801039c0 <mycpu>
...
80102f48:	74 f6                	je     80102f40 <main+0xe0>
  ...
  for(c = cpus; c < cpus+ncpu; c++){
80102f4a:	69 05 e0 36 11 80 b0 	imul   $0xb0,0x801136e0,%eax
80102f51:	00 00 00 
80102f54:	81 c3 b0 00 00 00    	add    $0xb0,%ebx
80102f5a:	05 60 31 11 80       	add    $0x80113160,%eax
...
80102f75:	e8 16 0b 00 00       	call   80103a90 <userinit>
...
80102fae:	e8 cd 18 00 00       	call   80104880 <memcmp>
...
80103072:	e8 09 18 00 00       	call   80104880 <memcmp>
...
801030cf:	a3 5c 30 11 80       	mov    %eax,0x8011305c
...
80103145:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  for(p=(uchar*)(conf+1), e=(uchar*)conf+conf->length; p<e; ){
    ...
    case MPPROC:
      ...
      if(ncpu < NCPU) {
80103148:	8b 0d e0 36 11 80    	mov    0x801136e0,%ecx
...
80103160:	89 0d e0 36 11 80    	mov    %ecx,0x801136e0
  for(p=(uchar*)(conf+1), e=(uchar*)conf+conf->length; p<e; ){
    switch(*p){
    case MPPROC:
      proc = (struct mpproc*)p;
      if(ncpu < NCPU) {
        cpus[ncpu].apicid = proc->apicid;  // apicid may differ from ncpu
80103166:	88 97 60 31 11 80    	mov    %dl,-0x7feecea0(%edi)
        ncpu++;
      }
...
8010317c:	83 c0 08             	add    $0x8,%eax
    ...
    case MPIOAPIC:
      ioapic = (struct mpioapic*)p;
      ioapicid = ioapic->apicno;
8010317f:	88 15 40 31 11 80    	mov    %dl,0x80113140
      p += sizeof(struct mpioapic);
      continue;
...
801031d0:	55                   	push   %ebp
    mt[0]= s & 0xffffffffUL;
801031d1:	ba 01 00 00 00       	mov    $0x1,%edx
static unsigned long mt[N]; /* the array for the state vector  */
static int mti=N+1; /* mti==N+1 means mt[N] is not initialized */
...
801031d8:	8b 45 08             	mov    0x8(%ebp),%eax
    mt[0]= s & 0xffffffffUL;
801031db:	a3 c0 a5 10 80       	mov    %eax,0x8010a5c0
801031e0:	eb 09                	jmp    801031eb <init_genrand+0x1b>
801031e2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
801031e8:	83 c2 01             	add    $0x1,%edx
    for (mti=1; mti<N; mti++) {
        mt[mti] = 
	    (1812433253UL * (mt[mti-1] ^ (mt[mti-1] >> 30)) + mti); 
801031eb:	89 c1                	mov    %eax,%ecx
801031ed:	c1 e9 1e             	shr    $0x1e,%ecx
801031f0:	31 c8                	xor    %ecx,%eax
801031f2:	69 c0 65 89 07 6c    	imul   $0x6c078965,%eax,%eax
...
void init_genrand(unsigned long s)
{
    mt[0]= s & 0xffffffffUL;
    for (mti=1; mti<N; mti++) {
801031fa:	81 fa 6f 02 00 00    	cmp    $0x26f,%edx
        mt[mti] = 
80103200:	89 04 95 c0 a5 10 80 	mov    %eax,-0x7fef5a40(,%edx,4)
...
void init_genrand(unsigned long s)
{
    mt[0]= s & 0xffffffffUL;
    for (mti=1; mti<N; mti++) {
80103207:	75 df                	jne    801031e8 <init_genrand+0x18>
80103209:	c7 05 00 a0 10 80 70 	movl   $0x270,0x8010a000
80103210:	02 00 00 
        mt[mti] = 
	    (1812433253UL * (mt[mti-1] ^ (mt[mti-1] >> 30)) + mti); 
        mt[mti] &= 0xffffffffUL;
...
80103213:	5d                   	pop    %ebp
80103214:	c3                   	ret    
80103215:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103219:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

80103220 <genrand_int32>:
{
    unsigned long y;
...
80103220:	a1 00 a0 10 80       	mov    0x8010a000,%eax
}
...
80103228:	53                   	push   %ebx
    ...
    if (mti >= N) { /* generate N words at one time */
80103229:	3d 6f 02 00 00       	cmp    $0x26f,%eax
8010322e:	0f 8e f1 00 00 00    	jle    80103325 <genrand_int32+0x105>
        int kk;

        if (mti == N+1)   /* if init_genrand() has not been called, */
80103234:	3d 71 02 00 00       	cmp    $0x271,%eax
80103239:	0f 84 f2 00 00 00    	je     80103331 <genrand_int32+0x111>
8010323f:	b9 c0 a5 10 80       	mov    $0x8010a5c0,%ecx
80103244:	ba 4c a9 10 80       	mov    $0x8010a94c,%edx
80103249:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
            init_genrand(5489UL); /* a default initial seed is used */

        for (kk=0;kk<N-M;kk++) {
            y = (mt[kk]&UPPER_MASK)|(mt[kk+1]&LOWER_MASK);
80103250:	8b 19                	mov    (%ecx),%ebx
80103252:	8b 41 04             	mov    0x4(%ecx),%eax
80103255:	83 c1 04             	add    $0x4,%ecx
80103258:	81 e3 00 00 00 80    	and    $0x80000000,%ebx
8010325e:	25 ff ff ff 7f       	and    $0x7fffffff,%eax
80103263:	09 d8                	or     %ebx,%eax
            mt[kk] = mt[kk+M] ^ (y >> 1) ^ mag01[y & 0x1UL];
80103265:	89 c3                	mov    %eax,%ebx
80103267:	83 e0 01             	and    $0x1,%eax
8010326a:	d1 eb                	shr    %ebx
8010326c:	33 99 30 06 00 00    	xor    0x630(%ecx),%ebx
80103272:	33 1c 85 50 78 10 80 	xor    -0x7fef87b0(,%eax,4),%ebx
80103279:	89 59 fc             	mov    %ebx,-0x4(%ecx)
        int kk;
        ...
        for (kk=0;kk<N-M;kk++) {
8010327c:	39 ca                	cmp    %ecx,%edx
8010327e:	75 d0                	jne    80103250 <genrand_int32+0x30>
80103280:	b9 7c af 10 80       	mov    $0x8010af7c,%ecx
80103285:	8d 76 00             	lea    0x0(%esi),%esi
        ...
        for (;kk<N-1;kk++) {
            y = (mt[kk]&UPPER_MASK)|(mt[kk+1]&LOWER_MASK);
80103288:	8b 1a                	mov    (%edx),%ebx
8010328a:	8b 42 04             	mov    0x4(%edx),%eax
8010328d:	83 c2 04             	add    $0x4,%edx
80103290:	81 e3 00 00 00 80    	and    $0x80000000,%ebx
80103296:	25 ff ff ff 7f       	and    $0x7fffffff,%eax
8010329b:	09 d8                	or     %ebx,%eax
            mt[kk] = mt[kk+(M-N)] ^ (y >> 1) ^ mag01[y & 0x1UL];
8010329d:	89 c3                	mov    %eax,%ebx
8010329f:	83 e0 01             	and    $0x1,%eax
801032a2:	d1 eb                	shr    %ebx
801032a4:	33 9a 70 fc ff ff    	xor    -0x390(%edx),%ebx
801032aa:	33 1c 85 50 78 10 80 	xor    -0x7fef87b0(,%eax,4),%ebx
801032b1:	89 5a fc             	mov    %ebx,-0x4(%edx)
        ...
        for (;kk<N-1;kk++) {
801032b4:	39 d1                	cmp    %edx,%ecx
801032b6:	75 d0                	jne    80103288 <genrand_int32+0x68>
            y = (mt[kk]&UPPER_MASK)|(mt[kk+1]&LOWER_MASK);
            mt[kk] = mt[kk+(M-N)] ^ (y >> 1) ^ mag01[y & 0x1UL];
        }
        y = (mt[N-1]&UPPER_MASK)|(mt[0]&LOWER_MASK);
801032b8:	a1 c0 a5 10 80       	mov    0x8010a5c0,%eax
801032bd:	8b 0d 7c af 10 80    	mov    0x8010af7c,%ecx
801032c3:	89 c2                	mov    %eax,%edx
801032c5:	81 e1 00 00 00 80    	and    $0x80000000,%ecx
801032cb:	81 e2 ff ff ff 7f    	and    $0x7fffffff,%edx
801032d1:	09 ca                	or     %ecx,%edx
        mt[N-1] = mt[M-1] ^ (y >> 1) ^ mag01[y & 0x1UL];
801032d3:	89 d1                	mov    %edx,%ecx
801032d5:	83 e2 01             	and    $0x1,%edx
801032d8:	d1 e9                	shr    %ecx
801032da:	33 0d f0 ab 10 80    	xor    0x8010abf0,%ecx
801032e0:	33 0c 95 50 78 10 80 	xor    -0x7fef87b0(,%edx,4),%ecx
801032e7:	ba 01 00 00 00       	mov    $0x1,%edx
801032ec:	89 0d 7c af 10 80    	mov    %ecx,0x8010af7c

        mti = 0;
    }
  
    y = mt[mti++];
801032f2:	89 15 00 a0 10 80    	mov    %edx,0x8010a000

    /* Tempering */
    y ^= (y >> 11);
801032f8:	89 c2                	mov    %eax,%edx
801032fa:	c1 ea 0b             	shr    $0xb,%edx
801032fd:	89 d1                	mov    %edx,%ecx
801032ff:	31 c1                	xor    %eax,%ecx
    y ^= (y << 7) & 0x9d2c5680UL;
80103301:	89 ca                	mov    %ecx,%edx
80103303:	c1 e2 07             	shl    $0x7,%edx
80103306:	89 d0                	mov    %edx,%eax
80103308:	25 80 56 2c 9d       	and    $0x9d2c5680,%eax
8010330d:	31 c1                	xor    %eax,%ecx
    y ^= (y << 15) & 0xefc60000UL;
8010330f:	89 c8                	mov    %ecx,%eax
80103311:	c1 e0 0f             	shl    $0xf,%eax
80103314:	25 00 00 c6 ef       	and    $0xefc60000,%eax
80103319:	31 c8                	xor    %ecx,%eax
    y ^= (y >> 18);
8010331b:	89 c2                	mov    %eax,%edx
8010331d:	c1 ea 12             	shr    $0x12,%edx

    return y;
80103320:	31 d0                	xor    %edx,%eax
}
80103322:	5b                   	pop    %ebx
80103323:	5d                   	pop    %ebp
80103324:	c3                   	ret    
80103325:	8d 50 01             	lea    0x1(%eax),%edx
80103328:	8b 04 85 c0 a5 10 80 	mov    -0x7fef5a40(,%eax,4),%eax
8010332f:	eb c1                	jmp    801032f2 <genrand_int32+0xd2>
static int mti=N+1; /* mti==N+1 means mt[N] is not initialized */
...
{
    mt[0]= s & 0xffffffffUL;
80103331:	c7 05 c0 a5 10 80 71 	movl   $0x1571,0x8010a5c0
80103338:	15 00 00 
8010333b:	ba 01 00 00 00       	mov    $0x1,%edx
80103340:	b8 71 15 00 00       	mov    $0x1571,%eax
80103345:	eb 0c                	jmp    80103353 <genrand_int32+0x133>
80103347:	89 f6                	mov    %esi,%esi
80103349:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
80103350:	83 c2 01             	add    $0x1,%edx
    for (mti=1; mti<N; mti++) {
        mt[mti] = 
	    (1812433253UL * (mt[mti-1] ^ (mt[mti-1] >> 30)) + mti); 
80103353:	89 c1                	mov    %eax,%ecx
80103355:	c1 e9 1e             	shr    $0x1e,%ecx
80103358:	31 c8                	xor    %ecx,%eax
8010335a:	69 c0 65 89 07 6c    	imul   $0x6c078965,%eax,%eax
...
void init_genrand(unsigned long s)
{
    mt[0]= s & 0xffffffffUL;
    for (mti=1; mti<N; mti++) {
80103362:	81 fa 6f 02 00 00    	cmp    $0x26f,%edx
        mt[mti] = 
80103368:	89 04 95 c0 a5 10 80 	mov    %eax,-0x7fef5a40(,%edx,4)
...
void init_genrand(unsigned long s)
{
    mt[0]= s & 0xffffffffUL;
    for (mti=1; mti<N; mti++) {
8010336f:	75 df                	jne    80103350 <genrand_int32+0x130>
80103371:	e9 c9 fe ff ff       	jmp    8010323f <genrand_int32+0x1f>
80103376:	8d 76 00             	lea    0x0(%esi),%esi
80103379:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

80103380 <genrand_real1>:
    return y;
}
...
80103386:	e8 95 fe ff ff       	call   80103220 <genrand_int32>
8010338b:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80103392:	89 45 f0             	mov    %eax,-0x10(%ebp)
80103395:	df 6d f0             	fildll -0x10(%ebp)
80103398:	dc 0d 58 78 10 80    	fmull  0x80107858
    /* divided by 2^32-1 */ 
}
8010339e:	c9                   	leave  
8010339f:	c3                   	ret    

801033a0 <pickRandomTicket>:

int pickRandomTicket(int total)
{
801033a0:	55                   	push   %ebp
801033a1:	89 e5                	mov    %esp,%ebp
801033a3:	83 ec 18             	sub    $0x18,%esp
}
...
{
    return genrand_int32()*(1.0/4294967295.0); 
801033a6:	e8 75 fe ff ff       	call   80103220 <genrand_int32>
}

int pickRandomTicket(int total)
{
  int ans = (int)(genrand_real1() * total);
  return (ans+1); 
801033ab:	d9 7d f6             	fnstcw -0xa(%ebp)
801033ae:	89 45 e8             	mov    %eax,-0x18(%ebp)
801033b1:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
801033b8:	df 6d e8             	fildll -0x18(%ebp)
801033bb:	0f b7 45 f6          	movzwl -0xa(%ebp),%eax
801033bf:	dc 0d 58 78 10 80    	fmull  0x80107858
801033c5:	b4 0c                	mov    $0xc,%ah
801033c7:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
801033cb:	db 45 08             	fildl  0x8(%ebp)
801033ce:	de c9                	fmulp  %st,%st(1)
801033d0:	d9 6d f4             	fldcw  -0xc(%ebp)
801033d3:	db 5d f0             	fistpl -0x10(%ebp)
801033d6:	d9 6d f6             	fldcw  -0xa(%ebp)
...
801033f1:	ba 21 00 00 00       	mov    $0x21,%edx
801033f6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
...
8010341c:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  struct pipe *p;

  p = 0;
  *f0 = *f1 = 0;
8010341f:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
80103425:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
  if((*f0 = filealloc()) == 0 || (*f1 = filealloc()) == 0)
8010342b:	e8 40 d9 ff ff       	call   80100d70 <filealloc>
80103430:	85 c0                	test   %eax,%eax
80103432:	89 06                	mov    %eax,(%esi)
80103434:	0f 84 a8 00 00 00    	je     801034e2 <pipealloc+0xd2>
8010343a:	e8 31 d9 ff ff       	call   80100d70 <filealloc>
8010343f:	85 c0                	test   %eax,%eax
80103441:	89 03                	mov    %eax,(%ebx)
80103443:	0f 84 87 00 00 00    	je     801034d0 <pipealloc+0xc0>
    goto bad;
  if((p = (struct pipe*)kalloc()) == 0)
80103449:	e8 42 f0 ff ff       	call   80102490 <kalloc>
...
80103458:	83 ec 08             	sub    $0x8,%esp
  *f0 = *f1 = 0;
  ...
  if((p = (struct pipe*)kalloc()) == 0)
    goto bad;
  p->readopen = 1;
8010345b:	c7 80 3c 02 00 00 01 	movl   $0x1,0x23c(%eax)
80103462:	00 00 00 
  p->writeopen = 1;
...
80103480:	00 00 00 
  initlock(&p->lock, "pipe");
80103483:	68 60 78 10 80       	push   $0x80107860
80103488:	50                   	push   %eax
80103489:	e8 32 11 00 00       	call   801045c0 <initlock>
  (*f0)->type = FD_PIPE;
...
801034da:	e8 51 d9 ff ff       	call   80100e30 <fileclose>
...
801034ec:	e8 3f d9 ff ff       	call   80100e30 <fileclose>
...
8010351f:	e8 9c 11 00 00       	call   801046c0 <acquire>
  if(writable){
...
8010353f:	e8 bc 0d 00 00       	call   80104300 <wakeup>
...
80103563:	5d                   	pop    %ebp
  ...
  if(p->readopen == 0 && p->writeopen == 0){
    ...
    release(&p->lock);
80103564:	e9 77 12 00 00       	jmp    801047e0 <release>
...
80103584:	e8 77 0d 00 00       	call   80104300 <wakeup>
...
801035a4:	5d                   	pop    %ebp
  ...
  if(p->readopen == 0 && p->writeopen == 0){
    release(&p->lock);
    kfree((char*)p);
801035a5:	e9 36 ed ff ff       	jmp    801022e0 <kfree>
...
801035bd:	e8 fe 10 00 00       	call   801046c0 <acquire>
  for(i = 0; i < n; i++){
801035c2:	8b 45 10             	mov    0x10(%ebp),%eax
801035c5:	83 c4 10             	add    $0x10,%esp
801035c8:	85 c0                	test   %eax,%eax
801035ca:	0f 8e b9 00 00 00    	jle    80103689 <pipewrite+0xd9>
...
801035df:	8d b3 38 02 00 00    	lea    0x238(%ebx),%esi
801035e5:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
801035e8:	03 4d 10             	add    0x10(%ebp),%ecx
801035eb:	89 4d e0             	mov    %ecx,-0x20(%ebp)
{
  int i;
  ...
  for(i = 0; i < n; i++){
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
801035ee:	8b 8b 34 02 00 00    	mov    0x234(%ebx),%ecx
801035f4:	8d 91 00 02 00 00    	lea    0x200(%ecx),%edx
801035fa:	39 d0                	cmp    %edx,%eax
801035fc:	74 38                	je     80103636 <pipewrite+0x86>
801035fe:	eb 59                	jmp    80103659 <pipewrite+0xa9>
      if(p->readopen == 0 || myproc()->killed){
80103600:	e8 5b 04 00 00       	call   80103a60 <myproc>
80103605:	8b 48 24             	mov    0x24(%eax),%ecx
80103608:	85 c9                	test   %ecx,%ecx
8010360a:	75 34                	jne    80103640 <pipewrite+0x90>
        release(&p->lock);
        return -1;
      }
      wakeup(&p->nread);
8010360c:	83 ec 0c             	sub    $0xc,%esp
8010360f:	57                   	push   %edi
80103610:	e8 eb 0c 00 00       	call   80104300 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
80103615:	58                   	pop    %eax
80103616:	5a                   	pop    %edx
80103617:	53                   	push   %ebx
80103618:	56                   	push   %esi
80103619:	e8 f2 0a 00 00       	call   80104110 <sleep>
{
  int i;
...
80103634:	75 2a                	jne    80103660 <pipewrite+0xb0>
      if(p->readopen == 0 || myproc()->killed){
80103636:	8b 83 3c 02 00 00    	mov    0x23c(%ebx),%eax
8010363c:	85 c0                	test   %eax,%eax
8010363e:	75 c0                	jne    80103600 <pipewrite+0x50>
        release(&p->lock);
80103640:	83 ec 0c             	sub    $0xc,%esp
80103643:	53                   	push   %ebx
80103644:	e8 97 11 00 00       	call   801047e0 <release>
        return -1;
...
80103666:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
8010366a:	81 e2 ff 01 00 00    	and    $0x1ff,%edx
80103670:	89 83 38 02 00 00    	mov    %eax,0x238(%ebx)
80103676:	0f b6 09             	movzbl (%ecx),%ecx
80103679:	88 4c 13 34          	mov    %cl,0x34(%ebx,%edx,1)
8010367d:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
pipewrite(struct pipe *p, char *addr, int n)
{
  int i;
  ...
  acquire(&p->lock);
  for(i = 0; i < n; i++){
80103680:	3b 4d e0             	cmp    -0x20(%ebp),%ecx
80103683:	0f 85 65 ff ff ff    	jne    801035ee <pipewrite+0x3e>
      wakeup(&p->nread);
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
    }
    p->data[p->nwrite++ % PIPESIZE] = addr[i];
...
80103693:	e8 68 0c 00 00       	call   80104300 <wakeup>
  release(&p->lock);
80103698:	89 1c 24             	mov    %ebx,(%esp)
8010369b:	e8 40 11 00 00       	call   801047e0 <release>
  return n;
801036a0:	83 c4 10             	add    $0x10,%esp
801036a3:	8b 45 10             	mov    0x10(%ebp),%eax
801036a6:	eb a9                	jmp    80103651 <pipewrite+0xa1>
801036a8:	90                   	nop
...
801036c0:	e8 fb 0f 00 00       	call   801046c0 <acquire>
...
801036f5:	e8 16 0a 00 00       	call   80104110 <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
80103713:	0f 84 97 00 00 00    	je     801037b0 <piperead+0x100>
    if(myproc()->killed){
80103719:	e8 42 03 00 00       	call   80103a60 <myproc>
...
80103729:	e8 b2 10 00 00       	call   801047e0 <release>
      return -1;
...
80103745:	7e 69                	jle    801037b0 <piperead+0x100>
    if(p->nread == p->nwrite)
80103747:	8b 83 34 02 00 00    	mov    0x234(%ebx),%eax
...
8010375e:	3b 83 38 02 00 00    	cmp    0x238(%ebx),%eax
80103764:	74 5a                	je     801037c0 <piperead+0x110>
      break;
    addr[i] = p->data[p->nread++ % PIPESIZE];
80103766:	8d 70 01             	lea    0x1(%eax),%esi
80103769:	25 ff 01 00 00       	and    $0x1ff,%eax
8010376e:	89 b3 34 02 00 00    	mov    %esi,0x234(%ebx)
80103774:	0f b6 44 03 34       	movzbl 0x34(%ebx,%eax,1),%eax
80103779:	88 04 0f             	mov    %al,(%edi,%ecx,1)
      release(&p->lock);
      return -1;
    }
    sleep(&p->nread, &p->lock); //DOC: piperead-sleep
  ...
  for(i = 0; i < n; i++){  //DOC: piperead-copy
8010377c:	83 c1 01             	add    $0x1,%ecx
8010377f:	39 4d 10             	cmp    %ecx,0x10(%ebp)
80103782:	75 d4                	jne    80103758 <piperead+0xa8>
    if(p->nread == p->nwrite)
      break;
    addr[i] = p->data[p->nread++ % PIPESIZE];
  }
  wakeup(&p->nwrite);  //DOC: piperead-wakeup
80103784:	8d 83 38 02 00 00    	lea    0x238(%ebx),%eax
8010378a:	83 ec 0c             	sub    $0xc,%esp
8010378d:	50                   	push   %eax
8010378e:	e8 6d 0b 00 00       	call   80104300 <wakeup>
  release(&p->lock);
80103793:	89 1c 24             	mov    %ebx,(%esp)
80103796:	e8 45 10 00 00       	call   801047e0 <release>
  return i;
8010379b:	8b 45 10             	mov    0x10(%ebp),%eax
...
801037d4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&ptable.lock);
801037d7:	68 20 37 11 80       	push   $0x80113720
801037dc:	e8 df 0e 00 00       	call   801046c0 <acquire>

  int unusedProcesses=0;
  if(initflag!=0)
801037e1:	8b 0d 84 af 10 80    	mov    0x8010af84,%ecx
801037e7:	83 c4 10             	add    $0x10,%esp
801037ea:	85 c9                	test   %ecx,%ecx
801037ec:	74 2a                	je     80103818 <allocproc+0x48>
801037ee:	31 d2                	xor    %edx,%edx
801037f0:	b8 54 37 11 80       	mov    $0x80113754,%eax
801037f5:	8d 76 00             	lea    0x0(%esi),%esi
  {
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
    {
      if(p->state == UNUSED)
        unusedProcesses++;
801037f8:	83 78 0c 01          	cmpl   $0x1,0xc(%eax)
801037fc:	83 d2 00             	adc    $0x0,%edx
  acquire(&ptable.lock);
  ...
  {
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801037ff:	05 84 00 00 00       	add    $0x84,%eax
80103804:	3d 54 58 11 80       	cmp    $0x80115854,%eax
80103809:	75 ed                	jne    801037f8 <allocproc+0x28>
    {
      if(p->state == UNUSED)
        unusedProcesses++;
    }
    AVAILABLE_TICKETS -= (NPROC-unusedProcesses-1); 
8010380b:	b8 3f 00 00 00       	mov    $0x3f,%eax
80103810:	29 d0                	sub    %edx,%eax
80103812:	29 05 10 a0 10 80    	sub    %eax,0x8010a010
  }
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103818:	bb 54 37 11 80       	mov    $0x80113754,%ebx
8010381d:	eb 13                	jmp    80103832 <allocproc+0x62>
8010381f:	90                   	nop
80103820:	81 c3 84 00 00 00    	add    $0x84,%ebx
80103826:	81 fb 54 58 11 80    	cmp    $0x80115854,%ebx
8010382c:	0f 84 f5 00 00 00    	je     80103927 <allocproc+0x157>
  {
    if(p->state == UNUSED)
80103832:	8b 53 0c             	mov    0xc(%ebx),%edx
80103835:	85 d2                	test   %edx,%edx
80103837:	75 e7                	jne    80103820 <allocproc+0x50>
  return 0;
...
found:
  ...
  p->state = EMBRYO;
  p->pid = nextpid++;
80103839:	a1 0c a0 10 80       	mov    0x8010a00c,%eax
...
found:
  p->ran = 0;
8010383e:	c7 83 80 00 00 00 00 	movl   $0x0,0x80(%ebx)
80103845:	00 00 00 
  p->state = EMBRYO;
80103848:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  p->pid = nextpid++;
8010384f:	8d 50 01             	lea    0x1(%eax),%edx
80103852:	89 43 10             	mov    %eax,0x10(%ebx)
  
  if(origflag!=0)
80103855:	a1 80 af 10 80       	mov    0x8010af80,%eax
  return 0;
...
found:
  ...
  p->state = EMBRYO;
  p->pid = nextpid++;
8010385a:	89 15 0c a0 10 80    	mov    %edx,0x8010a00c
  
  if(origflag!=0)
80103860:	85 c0                	test   %eax,%eax
80103862:	75 7c                	jne    801038e0 <allocproc+0x110>
...
80103864:	81 2d 10 a0 10 80 f4 	subl   $0x1f4,0x8010a010
8010386b:	01 00 00 
    ...
    origflag=1;
8010386e:	c7 05 80 af 10 80 01 	movl   $0x1,0x8010af80
80103875:	00 00 00 
    p->tickets=500;
80103878:	c7 43 7c f4 01 00 00 	movl   $0x1f4,0x7c(%ebx)
    AVAILABLE_TICKETS-=500;
  }

  release(&ptable.lock);
8010387f:	83 ec 0c             	sub    $0xc,%esp
80103882:	68 20 37 11 80       	push   $0x80113720
80103887:	e8 54 0f 00 00       	call   801047e0 <release>

  // Allocate kernel stack.
  if((p->kstack = kalloc()) == 0){
8010388c:	e8 ff eb ff ff       	call   80102490 <kalloc>
80103891:	83 c4 10             	add    $0x10,%esp
80103894:	85 c0                	test   %eax,%eax
80103896:	89 43 08             	mov    %eax,0x8(%ebx)
80103899:	0f 84 9f 00 00 00    	je     8010393e <allocproc+0x16e>
    return 0;
  }
  ...
  sp -= sizeof *p->tf;
8010389f:	8d 90 b4 0f 00 00    	lea    0xfb4(%eax),%edx
  sp -= 4;
...
801038a5:	83 ec 04             	sub    $0x4,%esp
  ...
  *(uint*)sp = (uint)trapret;
  ...
  sp -= sizeof *p->context;
801038a8:	05 9c 0f 00 00       	add    $0xf9c,%eax
    return 0;
  }
  sp = p->kstack + KSTACKSIZE;
  ...
  // Leave room for trap frame.
  sp -= sizeof *p->tf;
801038ad:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
801038b0:	c7 40 14 62 5a 10 80 	movl   $0x80105a62,0x14(%eax)

  sp -= sizeof *p->context;
  p->context = (struct context*)sp;
  memset(p->context, 0, sizeof *p->context);
801038b7:	6a 14                	push   $0x14
...
801038bb:	50                   	push   %eax
  ...
  *(uint*)sp = (uint)trapret;
  ...
  sp -= sizeof *p->context;
  p->context = (struct context*)sp;
801038bc:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
801038bf:	e8 6c 0f 00 00       	call   80104830 <memset>
  p->context->eip = (uint)forkret;
801038c4:	8b 43 1c             	mov    0x1c(%ebx),%eax
...
801038c7:	83 c4 10             	add    $0x10,%esp
  *(uint*)sp = (uint)trapret;
  ...
  memset(p->context, 0, sizeof *p->context);
  p->context->eip = (uint)forkret;
801038ca:	c7 40 10 50 39 10 80 	movl   $0x80103950,0x10(%eax)

  return p;
801038d1:	89 d8                	mov    %ebx,%eax
}
801038d3:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801038d6:	c9                   	leave  
801038d7:	c3                   	ret    
801038d8:	90                   	nop
801038d9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    ...
    selectedTickets = 1 + randomTicketAllocator(AVAILABLE_TICKETS);
801038e0:	8b 0d 10 a0 10 80    	mov    0x8010a010,%ecx
}
...
801038eb:	85 c9                	test   %ecx,%ecx
801038ed:	78 23                	js     80103912 <allocproc+0x142>
    return 0;
  unsigned long a = 1103515245, c = 12345;
  X = a * X + c; 
801038ef:	69 05 08 a0 10 80 6d 	imul   $0x41c64e6d,0x8010a008,%eax
801038f6:	4e c6 41 
801038f9:	31 d2                	xor    %edx,%edx
801038fb:	05 39 30 00 00       	add    $0x3039,%eax
80103900:	a3 08 a0 10 80       	mov    %eax,0x8010a008
80103905:	c1 e8 10             	shr    $0x10,%eax
80103908:	25 ff 7f 00 00       	and    $0x7fff,%eax
8010390d:	f7 f1                	div    %ecx
8010390f:	8d 42 01             	lea    0x1(%edx),%eax
    // else
    //   selectedTickets = 1 + randomTicketAllocator(AVAILABLE_TICKETS);
...
80103912:	29 c1                	sub    %eax,%ecx
    ...
    selectedTickets = 1 + randomTicketAllocator(AVAILABLE_TICKETS);
80103914:	a3 00 37 11 80       	mov    %eax,0x80113700
    p->tickets = selectedTickets;
80103919:	89 43 7c             	mov    %eax,0x7c(%ebx)
    AVAILABLE_TICKETS -= selectedTickets; 
8010391c:	89 0d 10 a0 10 80    	mov    %ecx,0x8010a010
80103922:	e9 58 ff ff ff       	jmp    8010387f <allocproc+0xaf>
  {
    if(p->state == UNUSED)
      goto found;
  }
...
8010392a:	68 20 37 11 80       	push   $0x80113720
8010392f:	e8 ac 0e 00 00       	call   801047e0 <release>
  return 0;
...
8010393d:	c3                   	ret    
  ...
  if((p->kstack = kalloc()) == 0){
    p->state = UNUSED;
8010393e:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    return 0;
80103945:	eb 8c                	jmp    801038d3 <allocproc+0x103>
...
80103953:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
80103956:	68 20 37 11 80       	push   $0x80113720
8010395b:	e8 80 0e 00 00       	call   801047e0 <release>

  if (first) {
80103960:	a1 04 a0 10 80       	mov    0x8010a004,%eax
...
80103970:	83 ec 0c             	sub    $0xc,%esp
  ...
  if (first) {
    ...
    // be run from main().
    first = 0;
80103973:	c7 05 04 a0 10 80 00 	movl   $0x0,0x8010a004
8010397a:	00 00 00 
    iinit(ROOTDEV);
8010397d:	6a 01                	push   $0x1
8010397f:	e8 ec da ff ff       	call   80101470 <iinit>
    initlog(ROOTDEV);
80103984:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010398b:	e8 20 f1 ff ff       	call   80102ab0 <initlog>
...
801039a6:	68 65 78 10 80       	push   $0x80107865
801039ab:	68 20 37 11 80       	push   $0x80113720
...
801039ca:	75 5b                	jne    80103a27 <mycpu+0x67>
    panic("mycpu called with interrupts enabled\n");
  
  apicid = lapicid();
801039cc:	e8 1f ed ff ff       	call   801026f0 <lapicid>
  // APIC IDs are not guaranteed to be contiguous. Maybe we should have
  // a reverse map, or reserve a register to store &cpus[i].
  for (i = 0; i < ncpu; ++i) {
801039d1:	8b 35 e0 36 11 80    	mov    0x801136e0,%esi
801039d7:	85 f6                	test   %esi,%esi
801039d9:	7e 3f                	jle    80103a1a <mycpu+0x5a>
    if (cpus[i].apicid == apicid)
801039db:	0f b6 15 60 31 11 80 	movzbl 0x80113160,%edx
801039e2:	39 d0                	cmp    %edx,%eax
801039e4:	74 30                	je     80103a16 <mycpu+0x56>
801039e6:	b9 10 32 11 80       	mov    $0x80113210,%ecx
...
801039f5:	74 23                	je     80103a1a <mycpu+0x5a>
    if (cpus[i].apicid == apicid)
...
80103a0d:	5b                   	pop    %ebx
  ...
  for (i = 0; i < ncpu; ++i) {
    if (cpus[i].apicid == apicid)
      return &cpus[i];
80103a0e:	05 60 31 11 80       	add    $0x80113160,%eax
  }
  panic("unknown apicid\n");
}
80103a13:	5e                   	pop    %esi
...
80103a18:	eb ea                	jmp    80103a04 <mycpu+0x44>
    if (cpus[i].apicid == apicid)
      return &cpus[i];
  }
  panic("unknown apicid\n");
80103a1a:	83 ec 0c             	sub    $0xc,%esp
80103a1d:	68 6c 78 10 80       	push   $0x8010786c
80103a22:	e8 49 c9 ff ff       	call   80100370 <panic>
mycpu(void)
{
  int apicid, i;
...
80103a2a:	68 64 79 10 80       	push   $0x80107964
80103a2f:	e8 3c c9 ff ff       	call   80100370 <panic>
...
80103a4b:	2d 60 31 11 80       	sub    $0x80113160,%eax
}
80103a50:	c9                   	leave  
}
...
80103a64:	83 ec 04             	sub    $0x4,%esp
  ...
  struct proc *p;
  pushcli();
80103a67:	e8 14 0c 00 00       	call   80104680 <pushcli>
  c = mycpu();
80103a6c:	e8 4f ff ff ff       	call   801039c0 <mycpu>
  p = c->proc;
80103a71:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103a77:	e8 f4 0c 00 00       	call   80104770 <popcli>
  return p;
}
...
80103a97:	e8 34 fd ff ff       	call   801037d0 <allocproc>
  initflag=1;
80103a9c:	c7 05 84 af 10 80 01 	movl   $0x1,0x8010af84
80103aa3:	00 00 00 
void
userinit(void)
{
  ...
  extern char _binary_initcode_start[], _binary_initcode_size[];
  p = allocproc();
80103aa6:	89 c3                	mov    %eax,%ebx
  initflag=1;
  initproc = p;
80103aa8:	a3 88 af 10 80       	mov    %eax,0x8010af88
  if((p->pgdir = setupkvm()) == 0)
80103aad:	e8 9e 35 00 00       	call   80107050 <setupkvm>
80103ab2:	85 c0                	test   %eax,%eax
80103ab4:	89 43 04             	mov    %eax,0x4(%ebx)
80103ab7:	0f 84 bd 00 00 00    	je     80103b7a <userinit+0xea>
    panic("userinit: out of memory?");
  inituvm(p->pgdir, _binary_initcode_start, (int)_binary_initcode_size);
80103abd:	83 ec 04             	sub    $0x4,%esp
80103ac0:	68 2c 00 00 00       	push   $0x2c
80103ac5:	68 60 a4 10 80       	push   $0x8010a460
80103aca:	50                   	push   %eax
80103acb:	e8 90 32 00 00       	call   80106d60 <inituvm>
  p->sz = PGSIZE;
  memset(p->tf, 0, sizeof(*p->tf));
80103ad0:	83 c4 0c             	add    $0xc,%esp
  initflag=1;
  initproc = p;
  if((p->pgdir = setupkvm()) == 0)
    panic("userinit: out of memory?");
  inituvm(p->pgdir, _binary_initcode_start, (int)_binary_initcode_size);
  p->sz = PGSIZE;
80103ad3:	c7 03 00 10 00 00    	movl   $0x1000,(%ebx)
  memset(p->tf, 0, sizeof(*p->tf));
80103ad9:	6a 4c                	push   $0x4c
80103adb:	6a 00                	push   $0x0
80103add:	ff 73 18             	pushl  0x18(%ebx)
80103ae0:	e8 4b 0d 00 00       	call   80104830 <memset>
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
80103ae5:	8b 43 18             	mov    0x18(%ebx),%eax
80103ae8:	ba 1b 00 00 00       	mov    $0x1b,%edx
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80103aed:	b9 23 00 00 00       	mov    $0x23,%ecx
  p->tf->es = p->tf->ds;
  p->tf->ss = p->tf->ds;
  p->tf->eflags = FL_IF;
  p->tf->esp = PGSIZE;
...
80103af2:	83 c4 0c             	add    $0xc,%esp
  ...
  memset(p->tf, 0, sizeof(*p->tf));
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
80103af5:	66 89 50 3c          	mov    %dx,0x3c(%eax)
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80103af9:	8b 43 18             	mov    0x18(%ebx),%eax
80103afc:	66 89 48 2c          	mov    %cx,0x2c(%eax)
  p->tf->es = p->tf->ds;
80103b00:	8b 43 18             	mov    0x18(%ebx),%eax
80103b03:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
80103b07:	66 89 50 28          	mov    %dx,0x28(%eax)
  p->tf->ss = p->tf->ds;
80103b0b:	8b 43 18             	mov    0x18(%ebx),%eax
80103b0e:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
80103b12:	66 89 50 48          	mov    %dx,0x48(%eax)
  p->tf->eflags = FL_IF;
80103b16:	8b 43 18             	mov    0x18(%ebx),%eax
80103b19:	c7 40 40 00 02 00 00 	movl   $0x200,0x40(%eax)
  p->tf->esp = PGSIZE;
80103b20:	8b 43 18             	mov    0x18(%ebx),%eax
80103b23:	c7 40 44 00 10 00 00 	movl   $0x1000,0x44(%eax)
  p->tf->eip = 0;  // beginning of initcode.S
80103b2a:	8b 43 18             	mov    0x18(%ebx),%eax
80103b2d:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)
  safestrcpy(p->name, "initcode", sizeof(p->name));
80103b34:	8d 43 6c             	lea    0x6c(%ebx),%eax
80103b37:	6a 10                	push   $0x10
80103b39:	68 95 78 10 80       	push   $0x80107895
80103b3e:	50                   	push   %eax
80103b3f:	e8 ec 0e 00 00       	call   80104a30 <safestrcpy>
  p->cwd = namei("/");
80103b44:	c7 04 24 9e 78 10 80 	movl   $0x8010789e,(%esp)
80103b4b:	e8 70 e3 ff ff       	call   80101ec0 <namei>
80103b50:	89 43 68             	mov    %eax,0x68(%ebx)
  ...
  acquire(&ptable.lock);
80103b53:	c7 04 24 20 37 11 80 	movl   $0x80113720,(%esp)
80103b5a:	e8 61 0b 00 00       	call   801046c0 <acquire>

  p->state = RUNNABLE;
80103b5f:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)

  release(&ptable.lock);
80103b66:	c7 04 24 20 37 11 80 	movl   $0x80113720,(%esp)
80103b6d:	e8 6e 0c 00 00       	call   801047e0 <release>
}
80103b72:	83 c4 10             	add    $0x10,%esp
80103b75:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80103b78:	c9                   	leave  
80103b79:	c3                   	ret    
  extern char _binary_initcode_start[], _binary_initcode_size[];
  p = allocproc();
...
80103b7d:	68 7c 78 10 80       	push   $0x8010787c
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103b98:	e8 e3 0a 00 00       	call   80104680 <pushcli>
  c = mycpu();
80103b9d:	e8 1e fe ff ff       	call   801039c0 <mycpu>
  p = c->proc;
80103ba2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ba8:	e8 c3 0b 00 00       	call   80104770 <popcli>
{
  uint sz;
  struct proc *curproc = myproc();
...
80103bb0:	8b 03                	mov    (%ebx),%eax
  if(n > 0){
80103bb2:	7e 34                	jle    80103be8 <growproc+0x58>
    if((sz = allocuvm(curproc->pgdir, sz, sz + n)) == 0)
80103bb4:	83 ec 04             	sub    $0x4,%esp
80103bb7:	01 c6                	add    %eax,%esi
80103bb9:	56                   	push   %esi
80103bba:	50                   	push   %eax
80103bbb:	ff 73 04             	pushl  0x4(%ebx)
80103bbe:	e8 dd 32 00 00       	call   80106ea0 <allocuvm>
80103bc3:	83 c4 10             	add    $0x10,%esp
80103bc6:	85 c0                	test   %eax,%eax
80103bc8:	74 36                	je     80103c00 <growproc+0x70>
  } else if(n < 0){
...
80103bca:	83 ec 0c             	sub    $0xc,%esp
  ...
  curproc->sz = sz;
80103bcd:	89 03                	mov    %eax,(%ebx)
  switchuvm(curproc);
80103bcf:	53                   	push   %ebx
80103bd0:	e8 7b 30 00 00       	call   80106c50 <switchuvm>
  return 0;
...
80103be8:	74 e0                	je     80103bca <growproc+0x3a>
    if((sz = deallocuvm(curproc->pgdir, sz, sz + n)) == 0)
80103bea:	83 ec 04             	sub    $0x4,%esp
80103bed:	01 c6                	add    %eax,%esi
80103bef:	56                   	push   %esi
80103bf0:	50                   	push   %eax
80103bf1:	ff 73 04             	pushl  0x4(%ebx)
80103bf4:	e8 a7 33 00 00       	call   80106fa0 <deallocuvm>
80103bf9:	83 c4 10             	add    $0x10,%esp
80103bfc:	85 c0                	test   %eax,%eax
80103bfe:	75 ca                	jne    80103bca <growproc+0x3a>
  struct proc *curproc = myproc();
  ...
  if(n > 0){
    if((sz = allocuvm(curproc->pgdir, sz, sz + n)) == 0)
      return -1;
80103c00:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103c05:	eb d3                	jmp    80103bda <growproc+0x4a>
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103c19:	e8 62 0a 00 00       	call   80104680 <pushcli>
  c = mycpu();
80103c1e:	e8 9d fd ff ff       	call   801039c0 <mycpu>
  p = c->proc;
80103c23:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103c29:	e8 42 0b 00 00       	call   80104770 <popcli>
  int i, pid;
  struct proc *np;
  struct proc *curproc = myproc();
  ...
  // Allocate process.
  if((np = allocproc()) == 0){
80103c2e:	e8 9d fb ff ff       	call   801037d0 <allocproc>
80103c33:	85 c0                	test   %eax,%eax
80103c35:	89 c7                	mov    %eax,%edi
80103c37:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80103c3a:	0f 84 b5 00 00 00    	je     80103cf5 <fork+0xe5>
    return -1;
  }
...
80103c43:	ff 33                	pushl  (%ebx)
80103c45:	ff 73 04             	pushl  0x4(%ebx)
80103c48:	e8 d3 34 00 00       	call   80107120 <copyuvm>
...
80103c8c:	e8 4f d1 ff ff       	call   80100de0 <filedup>
...
80103ca9:	83 c3 6c             	add    $0x6c,%ebx
  ...
  for(i = 0; i < NOFILE; i++)
    if(curproc->ofile[i])
      np->ofile[i] = filedup(curproc->ofile[i]);
  np->cwd = idup(curproc->cwd);
80103cac:	e8 8f d9 ff ff       	call   80101640 <idup>
...
80103cc1:	e8 6a 0d 00 00       	call   80104a30 <safestrcpy>

  pid = np->pid;
80103cc6:	8b 5f 10             	mov    0x10(%edi),%ebx

  acquire(&ptable.lock);
80103cc9:	c7 04 24 20 37 11 80 	movl   $0x80113720,(%esp)
80103cd0:	e8 eb 09 00 00       	call   801046c0 <acquire>

  np->state = RUNNABLE;
80103cd5:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)

  release(&ptable.lock);
80103cdc:	c7 04 24 20 37 11 80 	movl   $0x80113720,(%esp)
80103ce3:	e8 f8 0a 00 00       	call   801047e0 <release>

  return pid;
80103ce8:	83 c4 10             	add    $0x10,%esp
80103ceb:	89 d8                	mov    %ebx,%eax
}
80103ced:	8d 65 f4             	lea    -0xc(%ebp),%esp
80103cf0:	5b                   	pop    %ebx
80103cf1:	5e                   	pop    %esi
80103cf2:	5f                   	pop    %edi
80103cf3:	5d                   	pop    %ebp
80103cf4:	c3                   	ret    
  ...
  if((np = allocproc()) == 0){
    return -1;
80103cf5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103cfa:	eb f1                	jmp    80103ced <fork+0xdd>
  }
...
80103d02:	ff 77 08             	pushl  0x8(%edi)
80103d05:	e8 d6 e5 ff ff       	call   801022e0 <kfree>
    np->kstack = 0;
80103d0a:	c7 47 08 00 00 00 00 	movl   $0x0,0x8(%edi)
    np->state = UNUSED;
80103d11:	c7 47 0c 00 00 00 00 	movl   $0x0,0xc(%edi)
    return -1;
80103d18:	83 c4 10             	add    $0x10,%esp
80103d1b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103d20:	eb cb                	jmp    80103ced <fork+0xdd>
80103d22:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80103d29:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

80103d30 <countTotalTickets>:
  }
}
...
80103d31:	31 c0                	xor    %eax,%eax
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103d33:	ba 54 37 11 80       	mov    $0x80113754,%edx
  }
}
...
80103d3a:	eb 12                	jmp    80103d4e <countTotalTickets+0x1e>
80103d3c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  struct proc *p;
  int total = 0;
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103d40:	81 c2 84 00 00 00    	add    $0x84,%edx
80103d46:	81 fa 54 58 11 80    	cmp    $0x80115854,%edx
80103d4c:	74 17                	je     80103d65 <countTotalTickets+0x35>
    if (p->state == RUNNABLE) {
80103d4e:	83 7a 0c 03          	cmpl   $0x3,0xc(%edx)
80103d52:	75 ec                	jne    80103d40 <countTotalTickets+0x10>
      total += p->tickets;
80103d54:	03 42 7c             	add    0x7c(%edx),%eax
//Total number of tickets in all runnable processes
int countTotalTickets(void) 
{
  struct proc *p;
  int total = 0;
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103d57:	81 c2 84 00 00 00    	add    $0x84,%edx
80103d5d:	81 fa 54 58 11 80    	cmp    $0x80115854,%edx
80103d63:	75 e9                	jne    80103d4e <countTotalTickets+0x1e>
    if (p->state == RUNNABLE) {
      total += p->tickets;
    }
  }
...
80103d76:	83 ec 1c             	sub    $0x1c,%esp
  struct proc *p;
  struct cpu *c = mycpu();
80103d79:	e8 42 fc ff ff       	call   801039c0 <mycpu>
  c->proc = 0;
...
80103d8a:	8d 40 04             	lea    0x4(%eax),%eax
80103d8d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
}
...
80103d94:	31 ff                	xor    %edi,%edi
    ...
    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
80103d96:	68 20 37 11 80       	push   $0x80113720
80103d9b:	e8 20 09 00 00       	call   801046c0 <acquire>
...
int countTotalTickets(void) 
{
  ...
  int total = 0;
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103dc5:	05 84 00 00 00       	add    $0x84,%eax
80103dca:	3d 54 58 11 80       	cmp    $0x80115854,%eax
80103dcf:	75 eb                	jne    80103dbc <scheduler+0x4c>
    sti();
    ...
    if (totalTickets > 0) 
80103dd1:	85 ff                	test   %edi,%edi
80103dd3:	0f 8e 97 00 00 00    	jle    80103e70 <scheduler+0x100>
    {
      randomlyPickedTicket = pickRandomTicket(totalTickets);
80103dd9:	83 ec 0c             	sub    $0xc,%esp
80103ddc:	57                   	push   %edi
80103ddd:	e8 be f5 ff ff       	call   801033a0 <pickRandomTicket>
...
80103de7:	c1 f9 1f             	sar    $0x1f,%ecx
80103dea:	31 c8                	xor    %ecx,%eax
80103dec:	89 c6                	mov    %eax,%esi
80103dee:	29 ce                	sub    %ecx,%esi
80103df0:	39 f7                	cmp    %esi,%edi
80103df2:	7d 07                	jge    80103dfb <scheduler+0x8b>
        randomlyPickedTicket = randomlyPickedTicket % totalTickets;
80103df4:	89 f0                	mov    %esi,%eax
80103df6:	99                   	cltd   
80103df7:	f7 ff                	idiv   %edi
80103df9:	89 d6                	mov    %edx,%esi
//Total number of tickets in all runnable processes
int countTotalTickets(void) 
{
  struct proc *p;
  int total = 0;
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103dfb:	bf 54 37 11 80       	mov    $0x80113754,%edi
80103e00:	eb 14                	jmp    80103e16 <scheduler+0xa6>
80103e02:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      ...
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e08:	81 c7 84 00 00 00    	add    $0x84,%edi
80103e0e:	81 ff 54 58 11 80    	cmp    $0x80115854,%edi
80103e14:	74 5a                	je     80103e70 <scheduler+0x100>
        if (p->state == RUNNABLE) {
80103e16:	83 7f 0c 03          	cmpl   $0x3,0xc(%edi)
80103e1a:	75 ec                	jne    80103e08 <scheduler+0x98>
          randomlyPickedTicket = randomlyPickedTicket - p->tickets;
        } 
        if(p->state != RUNNABLE || randomlyPickedTicket >= 0) {
80103e1c:	2b 77 7c             	sub    0x7c(%edi),%esi
80103e1f:	79 e7                	jns    80103e08 <scheduler+0x98>
...
80103e21:	83 ec 0c             	sub    $0xc,%esp
        ...
        // before jumping back to us.
        c->proc = p;
80103e24:	89 bb ac 00 00 00    	mov    %edi,0xac(%ebx)
        switchuvm(p);
80103e2a:	57                   	push   %edi
80103e2b:	e8 20 2e 00 00       	call   80106c50 <switchuvm>
        p->state = RUNNING;
        p->ran++;
80103e30:	83 87 80 00 00 00 01 	addl   $0x1,0x80(%edi)
        // Switch to chosen process.  It is the process's job
        // to release ptable.lock and then reacquire it
        // before jumping back to us.
        c->proc = p;
        switchuvm(p);
        p->state = RUNNING;
80103e37:	c7 47 0c 04 00 00 00 	movl   $0x4,0xc(%edi)
        randomlyPickedTicket = randomlyPickedTicket * -1;
      ...
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e3e:	81 c7 84 00 00 00    	add    $0x84,%edi
        // before jumping back to us.
        c->proc = p;
        switchuvm(p);
        p->state = RUNNING;
...
80103e44:	58                   	pop    %eax
80103e45:	5a                   	pop    %edx
80103e46:	ff 77 98             	pushl  -0x68(%edi)
80103e49:	ff 75 e4             	pushl  -0x1c(%ebp)
80103e4c:	e8 54 0c 00 00       	call   80104aa5 <swtch>
        switchkvm();
80103e51:	e8 da 2d 00 00       	call   80106c30 <switchkvm>
...
80103e56:	83 c4 10             	add    $0x10,%esp
      ...
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e59:	81 ff 54 58 11 80    	cmp    $0x80115854,%edi
        swtch(&(c->scheduler), p->context);
        switchkvm();
        ...
        // It should have changed its p->state before coming back.
        c->proc = 0;
80103e5f:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103e66:	00 00 00 
        randomlyPickedTicket = randomlyPickedTicket * -1;
      ...
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e69:	75 ab                	jne    80103e16 <scheduler+0xa6>
80103e6b:	90                   	nop
...
80103e73:	68 20 37 11 80       	push   $0x80113720
80103e78:	e8 63 09 00 00       	call   801047e0 <release>
  }
80103e7d:	83 c4 10             	add    $0x10,%esp
80103e80:	e9 0b ff ff ff       	jmp    80103d90 <scheduler+0x20>
80103e85:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103e89:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

80103e90 <randomTicketAllocator>:
}
...
80103e98:	78 26                	js     80103ec0 <randomTicketAllocator+0x30>
    return 0;
  unsigned long a = 1103515245, c = 12345;
  X = a * X + c; 
80103e9a:	69 05 08 a0 10 80 6d 	imul   $0x41c64e6d,0x8010a008,%eax
80103ea1:	4e c6 41 
  return ((unsigned int)(X / 65536) % 32768) % M;
80103ea4:	31 d2                	xor    %edx,%edx
}
80103ea6:	5d                   	pop    %ebp
randomTicketAllocator(int M) 
{
  ...
  unsigned long a = 1103515245, c = 12345;
  X = a * X + c; 
80103ea7:	05 39 30 00 00       	add    $0x3039,%eax
80103eac:	a3 08 a0 10 80       	mov    %eax,0x8010a008
  return ((unsigned int)(X / 65536) % 32768) % M;
80103eb1:	c1 e8 10             	shr    $0x10,%eax
80103eb4:	25 ff 7f 00 00       	and    $0x7fff,%eax
80103eb9:	f7 f1                	div    %ecx
}
80103ebb:	89 d0                	mov    %edx,%eax
80103ebd:	c3                   	ret    
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103ed5:	e8 a6 07 00 00       	call   80104680 <pushcli>
  c = mycpu();
80103eda:	e8 e1 fa ff ff       	call   801039c0 <mycpu>
  p = c->proc;
80103edf:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ee5:	e8 86 08 00 00       	call   80104770 <popcli>
sched(void)
{
  int intena;
...
80103eed:	68 20 37 11 80       	push   $0x80113720
80103ef2:	e8 49 07 00 00       	call   80104640 <holding>
80103ef7:	83 c4 10             	add    $0x10,%esp
80103efa:	85 c0                	test   %eax,%eax
80103efc:	74 4f                	je     80103f4d <sched+0x7d>
    panic("sched ptable.lock");
  if(mycpu()->ncli != 1)
80103efe:	e8 bd fa ff ff       	call   801039c0 <mycpu>
...
80103f17:	75 41                	jne    80103f5a <sched+0x8a>
  ...
  intena = mycpu()->intena;
80103f19:	e8 a2 fa ff ff       	call   801039c0 <mycpu>
...
80103f21:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103f27:	e8 94 fa ff ff       	call   801039c0 <mycpu>
80103f2c:	83 ec 08             	sub    $0x8,%esp
80103f2f:	ff 70 04             	pushl  0x4(%eax)
80103f32:	53                   	push   %ebx
80103f33:	e8 6d 0b 00 00       	call   80104aa5 <swtch>
  mycpu()->intena = intena;
80103f38:	e8 83 fa ff ff       	call   801039c0 <mycpu>
}
...
80103f50:	68 a0 78 10 80       	push   $0x801078a0
80103f55:	e8 16 c4 ff ff       	call   80100370 <panic>
  if(mycpu()->ncli != 1)
    panic("sched locks");
  if(p->state == RUNNING)
    panic("sched running");
...
80103f5d:	68 cc 78 10 80       	push   $0x801078cc
80103f62:	e8 09 c4 ff ff       	call   80100370 <panic>
  if(!holding(&ptable.lock))
    panic("sched ptable.lock");
  if(mycpu()->ncli != 1)
    panic("sched locks");
...
80103f6a:	68 be 78 10 80       	push   $0x801078be
80103f6f:	e8 fc c3 ff ff       	call   80100370 <panic>
  struct proc *p = myproc();
...
80103f77:	68 b2 78 10 80       	push   $0x801078b2
80103f7c:	e8 ef c3 ff ff       	call   80100370 <panic>
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103f99:	e8 e2 06 00 00       	call   80104680 <pushcli>
  c = mycpu();
80103f9e:	e8 1d fa ff ff       	call   801039c0 <mycpu>
  p = c->proc;
80103fa3:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103fa9:	e8 c2 07 00 00       	call   80104770 <popcli>
{
  struct proc *curproc = myproc();
  struct proc *p;
  int fd;
  ...
  if(curproc == initproc)
80103fae:	39 35 88 af 10 80    	cmp    %esi,0x8010af88
...
80103fca:	e8 61 ce ff ff       	call   80100e30 <fileclose>
      curproc->ofile[fd] = 0;
...
80103fdd:	75 e1                	jne    80103fc0 <exit+0x30>
  ...
  begin_op();
80103fdf:	e8 6c eb ff ff       	call   80102b50 <begin_op>
  iput(curproc->cwd);
80103fe4:	83 ec 0c             	sub    $0xc,%esp
80103fe7:	ff 76 68             	pushl  0x68(%esi)
80103fea:	e8 b1 d7 ff ff       	call   801017a0 <iput>
  end_op();
80103fef:	e8 cc eb ff ff       	call   80102bc0 <end_op>
  curproc->cwd = 0;
80103ff4:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)

  acquire(&ptable.lock);
80103ffb:	c7 04 24 20 37 11 80 	movl   $0x80113720,(%esp)
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010400d:	b8 54 37 11 80       	mov    $0x80113754,%eax
80104012:	eb 10                	jmp    80104024 <exit+0x94>
80104014:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104018:	05 84 00 00 00       	add    $0x84,%eax
8010401d:	3d 54 58 11 80       	cmp    $0x80115854,%eax
80104022:	74 1e                	je     80104042 <exit+0xb2>
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104036:	05 84 00 00 00       	add    $0x84,%eax
8010403b:	3d 54 58 11 80       	cmp    $0x80115854,%eax
80104040:	75 e2                	jne    80104024 <exit+0x94>
  wakeup1(curproc->parent);
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->parent == curproc){
      p->parent = initproc;
80104042:	8b 0d 88 af 10 80    	mov    0x8010af88,%ecx
80104048:	ba 54 37 11 80       	mov    $0x80113754,%edx
...
8010404f:	90                   	nop
  ...
  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104050:	81 c2 84 00 00 00    	add    $0x84,%edx
80104056:	81 fa 54 58 11 80    	cmp    $0x80115854,%edx
8010405c:	74 3a                	je     80104098 <exit+0x108>
    if(p->parent == curproc){
...
8010406c:	b8 54 37 11 80       	mov    $0x80113754,%eax
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104078:	05 84 00 00 00       	add    $0x84,%eax
8010407d:	3d 54 58 11 80       	cmp    $0x80115854,%eax
80104082:	74 cc                	je     80104050 <exit+0xc0>
    if(p->state == SLEEPING && p->chan == chan)
...
801040a7:	68 ed 78 10 80       	push   $0x801078ed
801040ac:	e8 bf c2 ff ff       	call   80100370 <panic>
  struct proc *curproc = myproc();
  struct proc *p;
  int fd;
...
801040b4:	68 e0 78 10 80       	push   $0x801078e0
801040b9:	e8 b2 c2 ff ff       	call   80100370 <panic>
...
801040c7:	68 20 37 11 80       	push   $0x80113720
801040cc:	e8 ef 05 00 00       	call   801046c0 <acquire>
// while reading proc from the cpu structure
struct proc*
myproc(void) {
  struct cpu *c;
  struct proc *p;
  pushcli();
801040d1:	e8 aa 05 00 00       	call   80104680 <pushcli>
  c = mycpu();
801040d6:	e8 e5 f8 ff ff       	call   801039c0 <mycpu>
  p = c->proc;
801040db:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801040e1:	e8 8a 06 00 00       	call   80104770 <popcli>
// Give up the CPU for one scheduling round.
void
yield(void)
{
...
801040ed:	e8 de fd ff ff       	call   80103ed0 <sched>
  release(&ptable.lock);
801040f2:	c7 04 24 20 37 11 80 	movl   $0x80113720,(%esp)
801040f9:	e8 e2 06 00 00       	call   801047e0 <release>
}
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
8010411f:	e8 5c 05 00 00       	call   80104680 <pushcli>
  c = mycpu();
80104124:	e8 97 f8 ff ff       	call   801039c0 <mycpu>
  p = c->proc;
80104129:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010412f:	e8 3c 06 00 00       	call   80104770 <popcli>
void
sleep(void *chan, struct spinlock *lk)
{
  struct proc *p = myproc();
...
80104140:	81 fe 20 37 11 80    	cmp    $0x80113720,%esi
80104146:	74 50                	je     80104198 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104148:	83 ec 0c             	sub    $0xc,%esp
8010414b:	68 20 37 11 80       	push   $0x80113720
80104150:	e8 6b 05 00 00       	call   801046c0 <acquire>
    release(lk);
80104155:	89 34 24             	mov    %esi,(%esp)
80104158:	e8 83 06 00 00       	call   801047e0 <release>
  }
  // Go to sleep.
  p->chan = chan;
...
8010416c:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
  ...
  if(lk != &ptable.lock){  //DOC: sleeplock2
    release(&ptable.lock);
80104173:	c7 04 24 20 37 11 80 	movl   $0x80113720,(%esp)
8010417a:	e8 61 06 00 00       	call   801047e0 <release>
    acquire(lk);
...
8010418b:	5d                   	pop    %ebp
  ...
  if(lk != &ptable.lock){  //DOC: sleeplock2
    release(&ptable.lock);
    acquire(lk);
8010418c:	e9 2f 05 00 00       	jmp    801046c0 <acquire>
...
801041b9:	68 ff 78 10 80       	push   $0x801078ff
801041be:	e8 ad c1 ff ff       	call   80100370 <panic>
sleep(void *chan, struct spinlock *lk)
{
  struct proc *p = myproc();
...
801041c6:	68 f9 78 10 80       	push   $0x801078f9
801041cb:	e8 a0 c1 ff ff       	call   80100370 <panic>
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
801041d5:	e8 a6 04 00 00       	call   80104680 <pushcli>
  c = mycpu();
801041da:	e8 e1 f7 ff ff       	call   801039c0 <mycpu>
  p = c->proc;
801041df:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
801041e5:	e8 86 05 00 00       	call   80104770 <popcli>
{
  struct proc *p;
  int havekids, pid;
  struct proc *curproc = myproc();
...
801041ed:	68 20 37 11 80       	push   $0x80113720
801041f2:	e8 c9 04 00 00       	call   801046c0 <acquire>
...
801041fa:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801041fc:	bb 54 37 11 80       	mov    $0x80113754,%ebx
80104201:	eb 13                	jmp    80104216 <wait+0x46>
80104203:	90                   	nop
80104204:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104208:	81 c3 84 00 00 00    	add    $0x84,%ebx
8010420e:	81 fb 54 58 11 80    	cmp    $0x80115854,%ebx
80104214:	74 22                	je     80104238 <wait+0x68>
      if(p->parent != curproc)
...
8010421f:	74 3d                	je     8010425e <wait+0x8e>
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104221:	81 c3 84 00 00 00    	add    $0x84,%ebx
      if(p->parent != curproc)
        continue;
      havekids = 1;
80104227:	b8 01 00 00 00       	mov    $0x1,%eax
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010422c:	81 fb 54 58 11 80    	cmp    $0x80115854,%ebx
...
8010423a:	0f 84 a0 00 00 00    	je     801042e0 <wait+0x110>
80104240:	8b 46 24             	mov    0x24(%esi),%eax
80104243:	85 c0                	test   %eax,%eax
80104245:	0f 85 95 00 00 00    	jne    801042e0 <wait+0x110>
      release(&ptable.lock);
      return -1;
    }
...
8010424e:	68 20 37 11 80       	push   $0x80113720
80104253:	56                   	push   %esi
80104254:	e8 b7 fe ff ff       	call   80104110 <sleep>
  }
80104259:	83 c4 10             	add    $0x10,%esp
8010425c:	eb 9c                	jmp    801041fa <wait+0x2a>
        continue;
      havekids = 1;
      if(p->state == ZOMBIE){
        // Found one.
...
80104264:	ff b3 80 00 00 00    	pushl  0x80(%ebx)
      if(p->parent != curproc)
        continue;
      havekids = 1;
      if(p->state == ZOMBIE){
        // Found one.
        AVAILABLE_TICKETS += p->tickets;
8010426a:	8b 43 7c             	mov    0x7c(%ebx),%eax
8010426d:	01 05 10 a0 10 80    	add    %eax,0x8010a010
        //   cprintf("Proc %d chosen: %d times\n",proc2id, proc2chosen);
        //   proc2chosen=0;
        //   proc2=0;
        // }
...
80104274:	68 10 79 10 80       	push   $0x80107910
80104279:	e8 e2 c3 ff ff       	call   80100660 <cprintf>

        kfree(p->kstack);
8010427e:	5a                   	pop    %edx
8010427f:	ff 73 08             	pushl  0x8(%ebx)
80104282:	e8 59 e0 ff ff       	call   801022e0 <kfree>
        p->kstack = 0;
        freevm(p->pgdir);
80104287:	59                   	pop    %ecx
80104288:	ff 73 04             	pushl  0x4(%ebx)
        // }
        ...
        kfree(p->kstack);
        p->kstack = 0;
8010428b:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104292:	e8 39 2d 00 00       	call   80106fd0 <freevm>
        p->pid = 0;
80104297:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->ran = 0;
8010429e:	c7 83 80 00 00 00 00 	movl   $0x0,0x80(%ebx)
801042a5:	00 00 00 
        p->parent = 0;
801042a8:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
801042af:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
801042b3:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->tickets = 0;
801042ba:	c7 43 7c 00 00 00 00 	movl   $0x0,0x7c(%ebx)
        p->state = UNUSED;
801042c1:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
801042c8:	c7 04 24 20 37 11 80 	movl   $0x80113720,(%esp)
801042cf:	e8 0c 05 00 00       	call   801047e0 <release>
        return pid;
...
801042e3:	68 20 37 11 80       	push   $0x80113720
801042e8:	e8 f3 04 00 00       	call   801047e0 <release>
      return -1;
...
80104307:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
8010430a:	68 20 37 11 80       	push   $0x80113720
...
80104343:	3d 54 58 11 80       	cmp    $0x80115854,%eax
...
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
8010434a:	c7 45 08 20 37 11 80 	movl   $0x80113720,0x8(%ebp)
}
...
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
80104355:	e9 86 04 00 00       	jmp    801047e0 <release>
...
80104395:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
8010439c:	74 1a                	je     801043b8 <kill+0x58>
        p->state = RUNNABLE;
      release(&ptable.lock);
8010439e:	83 ec 0c             	sub    $0xc,%esp
801043a1:	68 20 37 11 80       	push   $0x80113720
801043a6:	e8 35 04 00 00       	call   801047e0 <release>
      return 0;
801043ab:	83 c4 10             	add    $0x10,%esp
801043ae:	31 c0                	xor    %eax,%eax
    }
  }
  release(&ptable.lock);
  return -1;
...
801043bf:	eb dd                	jmp    8010439e <kill+0x3e>
...
801043cb:	68 20 37 11 80       	push   $0x80113720
...
801043f9:	bb c0 37 11 80       	mov    $0x801137c0,%ebx
...
8010440b:	68 e3 79 10 80       	push   $0x801079e3
80104410:	e8 4b c2 ff ff       	call   80100660 <cprintf>
80104415:	83 c4 10             	add    $0x10,%esp
80104418:	81 c3 84 00 00 00    	add    $0x84,%ebx
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010441e:	81 fb c0 58 11 80    	cmp    $0x801158c0,%ebx
80104424:	0f 84 7e 00 00 00    	je     801044a8 <procdump+0xb8>
    if(p->state == UNUSED)
8010442a:	8b 43 a0             	mov    -0x60(%ebx),%eax
8010442d:	85 c0                	test   %eax,%eax
8010442f:	74 e7                	je     80104418 <procdump+0x28>
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104431:	83 f8 05             	cmp    $0x5,%eax
      state = states[p->state];
    else
      state = "???";
80104434:	ba 2a 79 10 80       	mov    $0x8010792a,%edx
  uint pc[10];
...
8010443b:	8b 14 85 8c 79 10 80 	mov    -0x7fef8674(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
80104442:	b8 2a 79 10 80       	mov    $0x8010792a,%eax
80104447:	85 d2                	test   %edx,%edx
80104449:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
8010444c:	53                   	push   %ebx
8010444d:	52                   	push   %edx
8010444e:	ff 73 a4             	pushl  -0x5c(%ebx)
80104451:	68 2e 79 10 80       	push   $0x8010792e
80104456:	e8 05 c2 ff ff       	call   80100660 <cprintf>
    if(p->state == SLEEPING){
8010445b:	83 c4 10             	add    $0x10,%esp
8010445e:	83 7b a0 02          	cmpl   $0x2,-0x60(%ebx)
...
80104478:	e8 63 01 00 00       	call   801045e0 <getcallerpcs>
...
801044ba:	68 a4 79 10 80       	push   $0x801079a4
...
80104515:	e8 f6 fb ff ff       	call   80104110 <sleep>
...
80104689:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010468a:	e8 31 f3 ff ff       	call   801039c0 <mycpu>
...
8010469f:	e8 1c f3 ff ff       	call   801039c0 <mycpu>
801046a4:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
801046aa:	e8 11 f3 ff ff       	call   801039c0 <mycpu>
...
801046f4:	e8 c7 f2 ff ff       	call   801039c0 <mycpu>
getcallerpcs(void *v, uint pcs[])
{
  uint *ebp;
  int i;
...
80104763:	68 af 79 10 80       	push   $0x801079af
...
8010477b:	75 52                	jne    801047cf <popcli+0x5f>
  ...
  if(--mycpu()->ncli < 0)
8010477d:	e8 3e f2 ff ff       	call   801039c0 <mycpu>
...
80104795:	e8 26 f2 ff ff       	call   801039c0 <mycpu>
...
801047a9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
{
  ...
  if(--mycpu()->ncli < 0)
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
801047b0:	e8 0b f2 ff ff       	call   801039c0 <mycpu>
...
801047c5:	68 ce 79 10 80       	push   $0x801079ce
...
801047d2:	68 b7 79 10 80       	push   $0x801079b7
...
801047f1:	68 d5 79 10 80       	push   $0x801079d5
...
80104803:	e8 b8 f1 ff ff       	call   801039c0 <mycpu>
...
80104a93:	83 ec 14             	sub    $0x14,%esp
  cprintf("HELLO\n\n");
80104a96:	68 dd 79 10 80       	push   $0x801079dd
80104a9b:	e8 c0 bb ff ff       	call   80100660 <cprintf>
  return;
...
swtch:
  movl 4(%esp), %eax
80104aa5:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80104aa9:	8b 54 24 08          	mov    0x8(%esp),%edx
...
80104aaf:	56                   	push   %esi
  pushl %edi
80104ab0:	57                   	push   %edi

  # Switch stacks
  movl %esp, (%eax)
80104ab1:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
80104ab3:	89 d4                	mov    %edx,%esp
...
80104ac7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104aca:	e8 91 ef ff ff       	call   80103a60 <myproc>
...
80104b07:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104b0a:	e8 51 ef ff ff       	call   80103a60 <myproc>
...
80104b25:	eb 29                	jmp    80104b50 <fetchstr+0x50>
...
80104b65:	e8 f6 ee ff ff       	call   80103a60 <myproc>
80104b6a:	8b 40 18             	mov    0x18(%eax),%eax
80104b6d:	8b 55 08             	mov    0x8(%ebp),%edx
...
{
  struct proc *curproc = myproc();
80104b76:	e8 e5 ee ff ff       	call   80103a60 <myproc>
...
{
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104b7d:	8d 73 04             	lea    0x4(%ebx),%esi
int
fetchint(uint addr, int *ip)
{
  struct proc *curproc = myproc();
...
80104bb8:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104bbb:	e8 a0 ee ff ff       	call   80103a60 <myproc>
80104bc0:	89 c6                	mov    %eax,%esi
 
  if(argint(n, &i) < 0)
80104bc2:	8d 45 f4             	lea    -0xc(%ebp),%eax
...
80104bd1:	c1 e8 1f             	shr    $0x1f,%eax
80104bd4:	83 c4 10             	add    $0x10,%esp
80104bd7:	84 c0                	test   %al,%al
80104bd9:	75 2d                	jne    80104c08 <argptr+0x58>
80104bdb:	89 d8                	mov    %ebx,%eax
80104bdd:	c1 e8 1f             	shr    $0x1f,%eax
80104be0:	84 c0                	test   %al,%al
80104be2:	75 24                	jne    80104c08 <argptr+0x58>
80104be4:	8b 16                	mov    (%esi),%edx
80104be6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104be9:	39 c2                	cmp    %eax,%edx
80104beb:	76 1b                	jbe    80104c08 <argptr+0x58>
80104bed:	01 c3                	add    %eax,%ebx
80104bef:	39 da                	cmp    %ebx,%edx
80104bf1:	72 15                	jb     80104c08 <argptr+0x58>
    return -1;
  *pp = (char*)i;
80104bf3:	8b 55 0c             	mov    0xc(%ebp),%edx
80104bf6:	89 02                	mov    %eax,(%edx)
  return 0;
80104bf8:	31 c0                	xor    %eax,%eax
}
...
80104c0d:	eb eb                	jmp    80104bfa <argptr+0x4a>
80104c0f:	90                   	nop
...
80104c32:	e8 c9 fe ff ff       	call   80104b00 <fetchstr>
...
80104c54:	53                   	push   %ebx
  int num;
  struct proc *curproc = myproc();
80104c55:	e8 06 ee ff ff       	call   80103a60 <myproc>

  num = curproc->tf->eax;
80104c5a:	8b 70 18             	mov    0x18(%eax),%esi
...
80104c5d:	89 c3                	mov    %eax,%ebx
  ...
  num = curproc->tf->eax;
80104c5f:	8b 46 1c             	mov    0x1c(%esi),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104c62:	8d 50 ff             	lea    -0x1(%eax),%edx
80104c65:	83 fa 14             	cmp    $0x14,%edx
80104c68:	77 1e                	ja     80104c88 <syscall+0x38>
80104c6a:	8b 14 85 20 7a 10 80 	mov    -0x7fef85e0(,%eax,4),%edx
80104c71:	85 d2                	test   %edx,%edx
80104c73:	74 13                	je     80104c88 <syscall+0x38>
    curproc->tf->eax = syscalls[num]();
80104c75:	ff d2                	call   *%edx
80104c77:	89 46 1c             	mov    %eax,0x1c(%esi)
  } else {
...
80104c88:	50                   	push   %eax
            curproc->pid, curproc->name, num);
80104c89:	8d 43 6c             	lea    0x6c(%ebx),%eax
...
80104c8d:	ff 73 10             	pushl  0x10(%ebx)
80104c90:	68 e5 79 10 80       	push   $0x801079e5
...
80104cc7:	89 4d bc             	mov    %ecx,-0x44(%ebp)
  ...
  if((dp = nameiparent(path, name)) == 0)
80104cca:	e8 11 d2 ff ff       	call   80101ee0 <nameiparent>
80104ccf:	83 c4 10             	add    $0x10,%esp
80104cd2:	85 c0                	test   %eax,%eax
80104cd4:	0f 84 f6 00 00 00    	je     80104dd0 <create+0x120>
    return 0;
  ilock(dp);
80104cda:	83 ec 0c             	sub    $0xc,%esp
80104cdd:	89 c7                	mov    %eax,%edi
...
80104ced:	57                   	push   %edi
80104cee:	e8 ad ce ff ff       	call   80101ba0 <dirlookup>
80104cf3:	83 c4 10             	add    $0x10,%esp
80104cf6:	85 c0                	test   %eax,%eax
80104cf8:	89 c3                	mov    %eax,%ebx
80104cfa:	74 54                	je     80104d50 <create+0xa0>
    iunlockput(dp);
...
80104d08:	e8 63 c9 ff ff       	call   80101670 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80104d0d:	83 c4 10             	add    $0x10,%esp
80104d10:	66 83 7d c4 02       	cmpw   $0x2,-0x3c(%ebp)
80104d15:	75 19                	jne    80104d30 <create+0x80>
80104d17:	66 83 7b 50 02       	cmpw   $0x2,0x50(%ebx)
80104d1c:	89 d8                	mov    %ebx,%eax
80104d1e:	75 10                	jne    80104d30 <create+0x80>
...
80104d34:	e8 c7 cb ff ff       	call   80101900 <iunlockput>
    return 0;
...
80104d50:	0f bf 45 c4          	movswl -0x3c(%ebp),%eax
80104d54:	83 ec 08             	sub    $0x8,%esp
80104d57:	50                   	push   %eax
80104d58:	ff 37                	pushl  (%edi)
80104d5a:	e8 a1 c7 ff ff       	call   80101500 <ialloc>
80104d5f:	83 c4 10             	add    $0x10,%esp
80104d62:	85 c0                	test   %eax,%eax
80104d64:	89 c3                	mov    %eax,%ebx
80104d66:	0f 84 cc 00 00 00    	je     80104e38 <create+0x188>
    panic("create: ialloc");
...
80104d70:	e8 fb c8 ff ff       	call   80101670 <ilock>
  ip->major = major;
80104d75:	0f b7 45 c0          	movzwl -0x40(%ebp),%eax
80104d79:	66 89 43 52          	mov    %ax,0x52(%ebx)
  ip->minor = minor;
80104d7d:	0f b7 45 bc          	movzwl -0x44(%ebp),%eax
80104d81:	66 89 43 54          	mov    %ax,0x54(%ebx)
  ip->nlink = 1;
80104d85:	b8 01 00 00 00       	mov    $0x1,%eax
80104d8a:	66 89 43 56          	mov    %ax,0x56(%ebx)
  iupdate(ip);
80104d8e:	89 1c 24             	mov    %ebx,(%esp)
80104d91:	e8 2a c8 ff ff       	call   801015c0 <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80104d96:	83 c4 10             	add    $0x10,%esp
80104d99:	66 83 7d c4 01       	cmpw   $0x1,-0x3c(%ebp)
80104d9e:	74 40                	je     80104de0 <create+0x130>
...
80104da3:	ff 73 04             	pushl  0x4(%ebx)
80104da6:	56                   	push   %esi
80104da7:	57                   	push   %edi
80104da8:	e8 53 d0 ff ff       	call   80101e00 <dirlink>
80104dad:	83 c4 10             	add    $0x10,%esp
80104db0:	85 c0                	test   %eax,%eax
80104db2:	78 77                	js     80104e2b <create+0x17b>
    panic("create: dirlink");

  iunlockput(dp);
80104db4:	83 ec 0c             	sub    $0xc,%esp
80104db7:	57                   	push   %edi
80104db8:	e8 43 cb ff ff       	call   80101900 <iunlockput>
...
80104dd2:	e9 49 ff ff ff       	jmp    80104d20 <create+0x70>
...
80104dd9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  if(type == T_DIR){  // Create . and .. entries.
    dp->nlink++;  // for ".."
80104de0:	66 83 47 56 01       	addw   $0x1,0x56(%edi)
    iupdate(dp);
80104de5:	83 ec 0c             	sub    $0xc,%esp
80104de8:	57                   	push   %edi
80104de9:	e8 d2 c7 ff ff       	call   801015c0 <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104dee:	83 c4 0c             	add    $0xc,%esp
80104df1:	ff 73 04             	pushl  0x4(%ebx)
80104df4:	68 94 7a 10 80       	push   $0x80107a94
80104df9:	53                   	push   %ebx
80104dfa:	e8 01 d0 ff ff       	call   80101e00 <dirlink>
80104dff:	83 c4 10             	add    $0x10,%esp
80104e02:	85 c0                	test   %eax,%eax
80104e04:	78 18                	js     80104e1e <create+0x16e>
80104e06:	83 ec 04             	sub    $0x4,%esp
80104e09:	ff 77 04             	pushl  0x4(%edi)
80104e0c:	68 93 7a 10 80       	push   $0x80107a93
80104e11:	53                   	push   %ebx
80104e12:	e8 e9 cf ff ff       	call   80101e00 <dirlink>
80104e17:	83 c4 10             	add    $0x10,%esp
80104e1a:	85 c0                	test   %eax,%eax
80104e1c:	79 82                	jns    80104da0 <create+0xf0>
      panic("create dots");
80104e1e:	83 ec 0c             	sub    $0xc,%esp
80104e21:	68 87 7a 10 80       	push   $0x80107a87
80104e26:	e8 45 b5 ff ff       	call   80100370 <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
    panic("create: dirlink");
80104e2b:	83 ec 0c             	sub    $0xc,%esp
80104e2e:	68 96 7a 10 80       	push   $0x80107a96
80104e33:	e8 38 b5 ff ff       	call   80100370 <panic>
    iunlockput(ip);
    return 0;
  }
...
80104e3b:	68 78 7a 10 80       	push   $0x80107a78
80104e40:	e8 2b b5 ff ff       	call   80100370 <panic>
...
80104e62:	e8 f9 fc ff ff       	call   80104b60 <argint>
80104e67:	83 c4 10             	add    $0x10,%esp
80104e6a:	85 c0                	test   %eax,%eax
80104e6c:	78 32                	js     80104ea0 <argfd.constprop.0+0x50>
    return -1;
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80104e6e:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80104e72:	77 2c                	ja     80104ea0 <argfd.constprop.0+0x50>
80104e74:	e8 e7 eb ff ff       	call   80103a60 <myproc>
80104e79:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104e7c:	8b 44 90 28          	mov    0x28(%eax,%edx,4),%eax
80104e80:	85 c0                	test   %eax,%eax
80104e82:	74 1c                	je     80104ea0 <argfd.constprop.0+0x50>
    return -1;
  if(pfd)
80104e84:	85 f6                	test   %esi,%esi
80104e86:	74 02                	je     80104e8a <argfd.constprop.0+0x3a>
    *pfd = fd;
80104e88:	89 16                	mov    %edx,(%esi)
  if(pf)
80104e8a:	85 db                	test   %ebx,%ebx
80104e8c:	74 22                	je     80104eb0 <argfd.constprop.0+0x60>
    *pf = f;
80104e8e:	89 03                	mov    %eax,(%ebx)
  return 0;
...
80104eb2:	eb de                	jmp    80104e92 <argfd.constprop.0+0x42>
...
80104eca:	83 ec 10             	sub    $0x10,%esp
  ...
  if(argfd(0, 0, &f) < 0)
80104ecd:	e8 7e ff ff ff       	call   80104e50 <argfd.constprop.0>
80104ed2:	85 c0                	test   %eax,%eax
80104ed4:	78 1a                	js     80104ef0 <sys_dup+0x30>
...
80104ed6:	31 db                	xor    %ebx,%ebx
  ...
  if(argfd(0, 0, &f) < 0)
    return -1;
  if((fd=fdalloc(f)) < 0)
80104ed8:	8b 75 f4             	mov    -0xc(%ebp),%esi
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80104edb:	e8 80 eb ff ff       	call   80103a60 <myproc>
...
80104efc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  for(fd = 0; fd < NOFILE; fd++){
    if(curproc->ofile[fd] == 0){
      curproc->ofile[fd] = f;
80104f00:	89 74 98 28          	mov    %esi,0x28(%eax,%ebx,4)
...
80104f0a:	e8 d1 be ff ff       	call   80100de0 <filedup>
  return fd;
...
80104f2b:	e8 20 ff ff ff       	call   80104e50 <argfd.constprop.0>
...
80104f3d:	e8 1e fc ff ff       	call   80104b60 <argint>
...
80104f55:	e8 56 fc ff ff       	call   80104bb0 <argptr>
...
80104f6d:	e8 de bf ff ff       	call   80100f50 <fileread>
...
80104f9b:	e8 b0 fe ff ff       	call   80104e50 <argfd.constprop.0>
...
80104fad:	e8 ae fb ff ff       	call   80104b60 <argint>
...
80104fc5:	e8 e6 fb ff ff       	call   80104bb0 <argptr>
...
80104fdd:	e8 fe bf ff ff       	call   80100fe0 <filewrite>
...
8010500c:	e8 3f fe ff ff       	call   80104e50 <argfd.constprop.0>
80105011:	85 c0                	test   %eax,%eax
80105013:	78 2b                	js     80105040 <sys_close+0x40>
    return -1;
  myproc()->ofile[fd] = 0;
80105015:	e8 46 ea ff ff       	call   80103a60 <myproc>
...
8010505b:	e8 f0 fd ff ff       	call   80104e50 <argfd.constprop.0>
...
8010506f:	e8 3c fb ff ff       	call   80104bb0 <argptr>
...
80105084:	e8 77 be ff ff       	call   80100f00 <filestat>
...
801050af:	e8 5c fb ff ff       	call   80104c10 <argstr>
...
801050c8:	e8 43 fb ff ff       	call   80104c10 <argstr>
...
801050d2:	0f 88 e2 00 00 00    	js     801051ba <sys_link+0x11a>
  ...
  begin_op();
801050d8:	e8 73 da ff ff       	call   80102b50 <begin_op>
  if((ip = namei(old)) == 0){
801050dd:	83 ec 0c             	sub    $0xc,%esp
801050e0:	ff 75 d4             	pushl  -0x2c(%ebp)
801050e3:	e8 d8 cd ff ff       	call   80101ec0 <namei>
...
80105118:	e8 a3 c4 ff ff       	call   801015c0 <iupdate>
  iunlock(ip);
8010511d:	89 1c 24             	mov    %ebx,(%esp)
80105120:	e8 2b c6 ff ff       	call   80101750 <iunlock>
...
8010512b:	e8 b0 cd ff ff       	call   80101ee0 <nameiparent>
...
80105153:	e8 a8 cc ff ff       	call   80101e00 <dirlink>
...
80105163:	e8 98 c7 ff ff       	call   80101900 <iunlockput>
  iput(ip);
80105168:	89 1c 24             	mov    %ebx,(%esp)
8010516b:	e8 30 c6 ff ff       	call   801017a0 <iput>

  end_op();
80105170:	e8 4b da ff ff       	call   80102bc0 <end_op>
...
801051a5:	e8 16 c4 ff ff       	call   801015c0 <iupdate>
  iunlockput(ip);
801051aa:	89 1c 24             	mov    %ebx,(%esp)
801051ad:	e8 4e c7 ff ff       	call   80101900 <iunlockput>
  end_op();
801051b2:	e8 09 da ff ff       	call   80102bc0 <end_op>
  return -1;
...
801051d4:	e8 27 c7 ff ff       	call   80101900 <iunlockput>
    end_op();
801051d9:	e8 e2 d9 ff ff       	call   80102bc0 <end_op>
    return -1;
...
801051e6:	eb 92                	jmp    8010517a <sys_link+0xda>
  ...
  if((ip = namei(old)) == 0){
    end_op();
801051e8:	e8 d3 d9 ff ff       	call   80102bc0 <end_op>
    return -1;
...
8010520f:	e8 fc f9 ff ff       	call   80104c10 <argstr>
...
8010521f:	8d 5d ca             	lea    -0x36(%ebp),%ebx
  ...
  begin_op();
80105222:	e8 29 d9 ff ff       	call   80102b50 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
...
80105248:	e8 23 c4 ff ff       	call   80101670 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
8010524d:	58                   	pop    %eax
8010524e:	5a                   	pop    %edx
8010524f:	68 94 7a 10 80       	push   $0x80107a94
80105254:	53                   	push   %ebx
80105255:	e8 26 c9 ff ff       	call   80101b80 <namecmp>
...
80105268:	68 93 7a 10 80       	push   $0x80107a93
8010526d:	53                   	push   %ebx
8010526e:	e8 0d c9 ff ff       	call   80101b80 <namecmp>
...
80105287:	e8 14 c9 ff ff       	call   80101ba0 <dirlookup>
...
80105341:	e8 0a c6 ff ff       	call   80101950 <readi>
...
80105359:	e8 a2 c5 ff ff       	call   80101900 <iunlockput>
    goto bad;
...
80105367:	e8 94 c5 ff ff       	call   80101900 <iunlockput>
  end_op();
8010536c:	e8 4f d8 ff ff       	call   80102bc0 <end_op>
  return -1;
...
80105394:	e8 27 c2 ff ff       	call   801015c0 <iupdate>
...
801053a6:	e9 6b ff ff ff       	jmp    80105316 <sys_unlink+0x116>
  ...
  if((dp = nameiparent(path, name)) == 0){
    end_op();
801053ab:	e8 10 d8 ff ff       	call   80102bc0 <end_op>
    return -1;
...
801053bd:	68 b8 7a 10 80       	push   $0x80107ab8
...
801053ca:	68 ca 7a 10 80       	push   $0x80107aca
...
801053d7:	68 a6 7a 10 80       	push   $0x80107aa6
...
801053ff:	e8 0c f8 ff ff       	call   80104c10 <argstr>
...
80105422:	0f 88 85 00 00 00    	js     801054ad <sys_open+0xbd>
  ...
  begin_op();
80105428:	e8 23 d7 ff ff       	call   80102b50 <begin_op>
...
8010543d:	e8 7e ca ff ff       	call   80101ec0 <namei>
...
80105453:	e8 18 c2 ff ff       	call   80101670 <ilock>
...
80105466:	e8 05 b9 ff ff       	call   80100d70 <filealloc>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80105473:	e8 e8 e5 ff ff       	call   80103a60 <myproc>
80105478:	90                   	nop
...
80105494:	e8 97 b9 ff ff       	call   80100e30 <fileclose>
80105499:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
8010549c:	83 ec 0c             	sub    $0xc,%esp
8010549f:	56                   	push   %esi
801054a0:	e8 5b c4 ff ff       	call   80101900 <iunlockput>
    end_op();
801054a5:	e8 16 d7 ff ff       	call   80102bc0 <end_op>
    return -1;
...
801054cf:	e8 dc f7 ff ff       	call   80104cb0 <create>
    if(ip == 0){
...
801054db:	75 89                	jne    80105466 <sys_open+0x76>
      end_op();
801054dd:	e8 de d6 ff ff       	call   80102bc0 <end_op>
      return -1;
...
801054f0:	83 ec 0c             	sub    $0xc,%esp
  ...
  for(fd = 0; fd < NOFILE; fd++){
    if(curproc->ofile[fd] == 0){
      curproc->ofile[fd] = f;
801054f3:	89 7c 98 28          	mov    %edi,0x28(%eax,%ebx,4)
      fileclose(f);
    iunlockput(ip);
    end_op();
    return -1;
...
801054f8:	e8 53 c2 ff ff       	call   80101750 <iunlock>
  end_op();
801054fd:	e8 be d6 ff ff       	call   80102bc0 <end_op>

  f->type = FD_INODE;
80105502:	c7 07 02 00 00 00    	movl   $0x2,(%edi)
  f->ip = ip;
  f->off = 0;
  f->readable = !(omode & O_WRONLY);
...
8010550b:	83 c4 10             	add    $0x10,%esp
  ...
  f->type = FD_INODE;
  f->ip = ip;
8010550e:	89 77 10             	mov    %esi,0x10(%edi)
  f->off = 0;
80105511:	c7 47 14 00 00 00 00 	movl   $0x0,0x14(%edi)
  f->readable = !(omode & O_WRONLY);
...
80105520:	83 e2 03             	and    $0x3,%edx
  ...
  f->off = 0;
  f->readable = !(omode & O_WRONLY);
80105523:	88 47 08             	mov    %al,0x8(%edi)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105526:	0f 95 47 09          	setne  0x9(%edi)
  return fd;
...
8010557f:	e8 2c f7 ff ff       	call   80104cb0 <create>
...
8010558f:	e8 6c c3 ff ff       	call   80101900 <iunlockput>
  end_op();
80105594:	e8 27 d6 ff ff       	call   80102bc0 <end_op>
  return 0;
...
8010560e:	e8 9d f6 ff ff       	call   80104cb0 <create>
...
8010561e:	e8 dd c2 ff ff       	call   80101900 <iunlockput>
  end_op();
80105623:	e8 98 d5 ff ff       	call   80102bc0 <end_op>
  return 0;
...
8010569d:	e8 fe c0 ff ff       	call   801017a0 <iput>
  end_op();
801056a2:	e8 19 d5 ff ff       	call   80102bc0 <end_op>
  curproc->cwd = ip;
...
801056c4:	e8 37 c2 ff ff       	call   80101900 <iunlockput>
    end_op();
801056c9:	e8 f2 d4 ff ff       	call   80102bc0 <end_op>
    return -1;
...
801056d9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
    end_op();
801056e0:	e8 db d4 ff ff       	call   80102bc0 <end_op>
    return -1;
...
80105705:	e8 06 f5 ff ff       	call   80104c10 <argstr>
...
8010571d:	e8 3e f4 ff ff       	call   80104b60 <argint>
...
80105748:	e8 e3 f0 ff ff       	call   80104830 <memset>
...
80105779:	e8 82 f3 ff ff       	call   80104b00 <fetchstr>
...
801057e1:	e8 ca f3 ff ff       	call   80104bb0 <argptr>
...
801057f8:	e8 13 dc ff ff       	call   80103410 <pipealloc>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80105809:	e8 52 e2 ff ff       	call   80103a60 <myproc>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80105852:	e8 09 e2 ff ff       	call   80103a60 <myproc>
...
8010586e:	75 f0                	jne    80105860 <sys_pipe+0x90>
  ...
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    if(fd0 >= 0)
      myproc()->ofile[fd0] = 0;
80105870:	e8 eb e1 ff ff       	call   80103a60 <myproc>
...
{
  return fork();
801058a4:	e9 67 e3 ff ff       	jmp    80103c10 <fork>
...
{
  return wait();
801058c4:	e9 07 e9 ff ff       	jmp    801041d0 <wait>
...
80105913:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105916:	e8 45 e1 ff ff       	call   80103a60 <myproc>
...
80105937:	78 27                	js     80105960 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105939:	e8 22 e1 ff ff       	call   80103a60 <myproc>
  if(growproc(n) < 0)
...
80105946:	e8 45 e2 ff ff       	call   80103b90 <growproc>
...
80105990:	68 60 58 11 80       	push   $0x80115860
...
8010599d:	83 c4 10             	add    $0x10,%esp
  ...
  acquire(&tickslock);
  ticks0 = ticks;
801059a0:	8b 1d a0 60 11 80    	mov    0x801160a0,%ebx
  while(ticks - ticks0 < n){
...
801059b3:	68 60 58 11 80       	push   $0x80115860
801059b8:	68 a0 60 11 80       	push   $0x801160a0
801059bd:	e8 4e e7 ff ff       	call   80104110 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801059c2:	a1 a0 60 11 80       	mov    0x801160a0,%eax
...
801059e0:	68 60 58 11 80       	push   $0x80115860
...
80105a03:	68 60 58 11 80       	push   $0x80115860
...
80105a24:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105a27:	68 60 58 11 80       	push   $0x80115860
80105a2c:	e8 8f ec ff ff       	call   801046c0 <acquire>
  xticks = ticks;
80105a31:	8b 1d a0 60 11 80    	mov    0x801160a0,%ebx
  release(&tickslock);
80105a37:	c7 04 24 60 58 11 80 	movl   $0x80115860,(%esp)
...
80105a78:	8b 14 85 14 a0 10 80 	mov    -0x7fef5fec(,%eax,4),%edx
80105a7f:	b9 08 00 00 00       	mov    $0x8,%ecx
80105a84:	c6 04 c5 a4 58 11 80 	movb   $0x0,-0x7feea75c(,%eax,8)
80105a8b:	00 
80105a8c:	66 89 0c c5 a2 58 11 	mov    %cx,-0x7feea75e(,%eax,8)
80105a93:	80 
80105a94:	c6 04 c5 a5 58 11 80 	movb   $0x8e,-0x7feea75b(,%eax,8)
80105a9b:	8e 
80105a9c:	66 89 14 c5 a0 58 11 	mov    %dx,-0x7feea760(,%eax,8)
80105aa3:	80 
80105aa4:	c1 ea 10             	shr    $0x10,%edx
80105aa7:	66 89 14 c5 a6 58 11 	mov    %dx,-0x7feea75a(,%eax,8)
80105aae:	80 
void
tvinit(void)
{
...
80105ac1:	83 ec 10             	sub    $0x10,%esp
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105ac4:	a1 14 a1 10 80       	mov    0x8010a114,%eax

  initlock(&tickslock, "time");
80105ac9:	68 d9 7a 10 80       	push   $0x80107ad9
80105ace:	68 60 58 11 80       	push   $0x80115860
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105ad3:	66 89 15 a2 5a 11 80 	mov    %dx,0x80115aa2
80105ada:	c6 05 a4 5a 11 80 00 	movb   $0x0,0x80115aa4
80105ae1:	66 a3 a0 5a 11 80    	mov    %ax,0x80115aa0
80105ae7:	c1 e8 10             	shr    $0x10,%eax
80105aea:	c6 05 a5 5a 11 80 ef 	movb   $0xef,0x80115aa5
80105af1:	66 a3 a6 5a 11 80    	mov    %ax,0x80115aa6
...
80105b1b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105b1f:	b8 a0 58 11 80       	mov    $0x801158a0,%eax
...
80105b60:	ff 24 85 80 7b 10 80 	jmp    *-0x7fef8480(,%eax,4)
...
80105b70:	e8 eb de ff ff       	call   80103a60 <myproc>
...
80105bc5:	68 3c 7b 10 80       	push   $0x80107b3c
...
80105bd2:	e8 89 de ff ff       	call   80103a60 <myproc>
...
80105be0:	e8 7b de ff ff       	call   80103a60 <myproc>
...
80105bf5:	e8 66 de ff ff       	call   80103a60 <myproc>
80105bfa:	85 c0                	test   %eax,%eax
80105bfc:	74 0b                	je     80105c09 <trap+0xc9>
80105bfe:	e8 5d de ff ff       	call   80103a60 <myproc>
...
80105c07:	74 4f                	je     80105c58 <trap+0x118>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c09:	e8 52 de ff ff       	call   80103a60 <myproc>
80105c0e:	85 c0                	test   %eax,%eax
80105c10:	74 1d                	je     80105c2f <trap+0xef>
80105c12:	e8 49 de ff ff       	call   80103a60 <myproc>
...
80105c4b:	75 a8                	jne    80105bf5 <trap+0xb5>
    exit();
80105c4d:	e8 3e e3 ff ff       	call   80103f90 <exit>
...
80105c5c:	75 ab                	jne    80105c09 <trap+0xc9>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();
80105c5e:	e8 5d e4 ff ff       	call   801040c0 <yield>
...
80105c65:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80105c68:	e8 d3 dd ff ff       	call   80103a40 <cpuid>
...
80105c7f:	90                   	nop
  ...
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80105c80:	e8 4b c9 ff ff       	call   801025d0 <kbdintr>
    lapiceoi();
...
80105ca7:	e8 94 dd ff ff       	call   80103a40 <cpuid>
80105cac:	56                   	push   %esi
80105cad:	53                   	push   %ebx
80105cae:	50                   	push   %eax
80105caf:	68 e4 7a 10 80       	push   $0x80107ae4
80105cb4:	e8 a7 a9 ff ff       	call   80100660 <cprintf>
            cpuid(), tf->cs, tf->eip);
    lapiceoi();
80105cb9:	e8 52 ca ff ff       	call   80102710 <lapiceoi>
    break;
...
80105cc9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80105cd0:	e8 7b c3 ff ff       	call   80102050 <ideintr>
...
80105cea:	75 2c                	jne    80105d18 <trap+0x1d8>
      exit();
    myproc()->tf = tf;
80105cec:	e8 6f dd ff ff       	call   80103a60 <myproc>
80105cf1:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105cf4:	e8 57 ef ff ff       	call   80104c50 <syscall>
    if(myproc()->killed)
...
80105d0f:	5d                   	pop    %ebp
    ...
    if(myproc()->killed)
      exit();
80105d10:	e9 7b e2 ff ff       	jmp    80103f90 <exit>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
      exit();
80105d18:	e8 73 e2 ff ff       	call   80103f90 <exit>
...
80105d23:	68 60 58 11 80       	push   $0x80115860
80105d28:	e8 93 e9 ff ff       	call   801046c0 <acquire>
      ticks++;
      wakeup(&ticks);
80105d2d:	c7 04 24 a0 60 11 80 	movl   $0x801160a0,(%esp)
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
      acquire(&tickslock);
      ticks++;
80105d34:	83 05 a0 60 11 80 01 	addl   $0x1,0x801160a0
      wakeup(&ticks);
80105d3b:	e8 c0 e5 ff ff       	call   80104300 <wakeup>
      release(&tickslock);
80105d40:	c7 04 24 60 58 11 80 	movl   $0x80115860,(%esp)
...
80105d5a:	e8 e1 dc ff ff       	call   80103a40 <cpuid>
...
80105d68:	68 08 7b 10 80       	push   $0x80107b08
80105d6d:	e8 ee a8 ff ff       	call   80100660 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
80105d72:	83 c4 14             	add    $0x14,%esp
80105d75:	68 de 7a 10 80       	push   $0x80107ade
...
{
  if(!uart)
80105d80:	a1 8c af 10 80       	mov    0x8010af8c,%eax
  outb(COM1+0, c);
}
...
80105e57:	74 5a                	je     80105eb3 <uartinit+0xb3>
    return;
  uart = 1;
80105e59:	c7 05 8c af 10 80 01 	movl   $0x1,0x8010af8c
80105e60:	00 00 00 
...
80105e6f:	bb 00 7c 10 80       	mov    $0x80107c00,%ebx
...
uartputc(int c)
{
  ...
  if(!uart)
80105e9a:	8b 15 8c af 10 80    	mov    0x8010af8c,%edx
...
uartputc(int c)
{
  ...
  if(!uart)
80105ec0:	8b 15 8c af 10 80    	mov    0x8010af8c,%edx
    uartputc(*p);
}
...
80106a7d:	68 08 7c 10 80       	push   $0x80107c08
...
80106b33:	83 ec 18             	sub    $0x18,%esp
  ...
  c = &cpus[cpuid()];
80106b36:	e8 05 cf ff ff       	call   80103a40 <cpuid>
...
80106b48:	66 89 90 d8 31 11 80 	mov    %dx,-0x7feece28(%eax)
80106b4f:	66 89 88 da 31 11 80 	mov    %cx,-0x7feece26(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106b56:	ba ff ff ff ff       	mov    $0xffffffff,%edx
80106b5b:	31 c9                	xor    %ecx,%ecx
80106b5d:	66 89 90 e0 31 11 80 	mov    %dx,-0x7feece20(%eax)
...
80106b64:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  ...
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106b69:	66 89 88 e2 31 11 80 	mov    %cx,-0x7feece1e(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106b70:	31 c9                	xor    %ecx,%ecx
80106b72:	66 89 90 e8 31 11 80 	mov    %dx,-0x7feece18(%eax)
80106b79:	66 89 88 ea 31 11 80 	mov    %cx,-0x7feece16(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106b80:	ba ff ff ff ff       	mov    $0xffffffff,%edx
80106b85:	31 c9                	xor    %ecx,%ecx
80106b87:	66 89 90 f0 31 11 80 	mov    %dx,-0x7feece10(%eax)
  // Map "logical" addresses to virtual addresses using identity map.
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpuid()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106b8e:	c6 80 dc 31 11 80 00 	movb   $0x0,-0x7feece24(%eax)
static inline void
...
80106b9a:	c6 80 dd 31 11 80 9a 	movb   $0x9a,-0x7feece23(%eax)
80106ba1:	c6 80 de 31 11 80 cf 	movb   $0xcf,-0x7feece22(%eax)
80106ba8:	c6 80 df 31 11 80 00 	movb   $0x0,-0x7feece21(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106baf:	c6 80 e4 31 11 80 00 	movb   $0x0,-0x7feece1c(%eax)
80106bb6:	c6 80 e5 31 11 80 92 	movb   $0x92,-0x7feece1b(%eax)
80106bbd:	c6 80 e6 31 11 80 cf 	movb   $0xcf,-0x7feece1a(%eax)
80106bc4:	c6 80 e7 31 11 80 00 	movb   $0x0,-0x7feece19(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106bcb:	c6 80 ec 31 11 80 00 	movb   $0x0,-0x7feece14(%eax)
80106bd2:	c6 80 ed 31 11 80 fa 	movb   $0xfa,-0x7feece13(%eax)
80106bd9:	c6 80 ee 31 11 80 cf 	movb   $0xcf,-0x7feece12(%eax)
80106be0:	c6 80 ef 31 11 80 00 	movb   $0x0,-0x7feece11(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106be7:	66 89 88 f2 31 11 80 	mov    %cx,-0x7feece0e(%eax)
80106bee:	c6 80 f4 31 11 80 00 	movb   $0x0,-0x7feece0c(%eax)
80106bf5:	c6 80 f5 31 11 80 f2 	movb   $0xf2,-0x7feece0b(%eax)
80106bfc:	c6 80 f6 31 11 80 cf 	movb   $0xcf,-0x7feece0a(%eax)
80106c03:	c6 80 f7 31 11 80 00 	movb   $0x0,-0x7feece09(%eax)
  lgdt(c->gdt, sizeof(c->gdt));
80106c0a:	05 d0 31 11 80       	add    $0x801131d0,%eax
...
80106c30:	a1 a4 60 11 80       	mov    0x801160a4,%eax
...
80106c7f:	e8 3c cd ff ff       	call   801039c0 <mycpu>
80106c84:	89 c3                	mov    %eax,%ebx
80106c86:	e8 35 cd ff ff       	call   801039c0 <mycpu>
80106c8b:	89 c7                	mov    %eax,%edi
80106c8d:	e8 2e cd ff ff       	call   801039c0 <mycpu>
80106c92:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106c95:	83 c7 08             	add    $0x8,%edi
80106c98:	e8 23 cd ff ff       	call   801039c0 <mycpu>
...
80106cd9:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
  ...
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
80106cde:	e8 dd cc ff ff       	call   801039c0 <mycpu>
80106ce3:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106cea:	e8 d1 cc ff ff       	call   801039c0 <mycpu>
80106cef:	b9 10 00 00 00       	mov    $0x10,%ecx
80106cf4:	66 89 48 10          	mov    %cx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106cf8:	e8 c3 cc ff ff       	call   801039c0 <mycpu>
...
80106d06:	89 48 0c             	mov    %ecx,0xc(%eax)
  ...
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106d09:	e8 b2 cc ff ff       	call   801039c0 <mycpu>
...
80106d34:	68 0e 7c 10 80       	push   $0x80107c0e
...
80106d41:	68 39 7c 10 80       	push   $0x80107c39
...
80106d4e:	68 24 7c 10 80       	push   $0x80107c24
...
80106dc9:	68 4d 7c 10 80       	push   $0x80107c4d
...
80106e7d:	68 67 7c 10 80       	push   $0x80107c67
...
80106e8a:	68 08 7d 10 80       	push   $0x80107d08
...
80106f21:	68 85 7c 10 80       	push   $0x80107c85
...
80106f53:	68 9d 7c 10 80       	push   $0x80107c9d
...
8010703c:	68 b9 7c 10 80       	push   $0x80107cb9
...
801070db:	a3 a4 60 11 80       	mov    %eax,0x801160a4
...
8010710f:	68 ca 7c 10 80       	push   $0x80107cca
...
801071f2:	68 ee 7c 10 80       	push   $0x80107cee
...
801071ff:	68 d4 7c 10 80       	push   $0x80107cd4
